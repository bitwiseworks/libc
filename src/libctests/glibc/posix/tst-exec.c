...
do_test (int argc, char *argv[])
{
  ...
  */
  ...
  if (restart)
    {
      if (argc != 4)
	error (EXIT_FAILURE, 0, "wrong number of arguments (%d) argv[0]=%s argv[1]=%s argv[2]=%s argv[3]=%s argv[4]=%s argv[5]=%s argv[6]=%s argv[7]=%s argv[8]=%s",
               argc, argc > 0 ? argv[0] : "<null>", argc > 1 ? argv[1] : "<null>", argc > 2 ? argv[2] : "<null>", argc > 3 ? argv[3] : "<null>",
               argc > 4 ? argv[4] : "<null>", argc > 5 ? argv[5] : "<null>", argc > 6 ? argv[6] : "<null>", argc > 7 ? argv[7] : "<null>",
               argc > 8 ? argv[8] : "<null>");
  ...
  if (argc != 5)
    error (EXIT_FAILURE, 0, "wrong number of arguments (%d) argv[0]=%s argv[1]=%s argv[2]=%s argv[3]=%s argv[4]=%s",
           argc, argc > 0 ? argv[0] : "<null>", argc > 1 ? argv[1] : "<null>", argc > 2 ? argv[2] : "<null>",
