/* $Id: PrfTiming.h 2055 2005-06-19 08:04:00Z bird $
 *
 * Common timing code.
 *
...
static inline long double gettime(void)
{
    QWORD   qw;
    DosTmrQueryTime(&qw);
...
static inline unsigned getHz(void)
{
    ULONG ul = -1;
    DosTmrQueryFreq(&ul);
    return ul;
...
static inline void printSystemInfo(void)
{
}
