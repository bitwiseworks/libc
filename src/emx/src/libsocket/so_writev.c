/* $Id: so_writev.c 1454 2004-09-04 06:22:38Z bird $ */
/** @file
 *
 * so_writev().
 *
...
ssize_t so_writev(int socket, struct iovec *iov, int iovcnt)
{
    ...
    {
        ssize_t rc;
        rc = __libsocket_so_writev(pFHSocket->iSocket, iov, iovcnt);
        if (rc >= 0)
