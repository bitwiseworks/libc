/* $Id: futimes.c 2254 2005-07-17 12:25:44Z bird $ */
/** @file
 *
 * LIBC - futimes.
 *
...
int _STD(futimes)(int fh, const struct timeval *paTimes)
{
    ...
    int rc = __libc_Back_fsFileTimesSetFH(fh, paTimes);
    if (!rc)
