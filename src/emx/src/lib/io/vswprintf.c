/*
    vswprintf.c -- copied from vsnprint.c
...
int _STD(vswprintf) (wchar_t *buffer, size_t n, const wchar_t *format, va_list arg_ptr)
{
  FILE trick;
  int result;
  ...
  /* As opposed to vsnprintf, POSIX requires the wide version to return -1
