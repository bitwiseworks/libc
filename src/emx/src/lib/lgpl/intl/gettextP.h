...
#if defined(__GNUC__) && !defined(IN_INNOTEK_LIBC)
# define ZERO 0
#else
# define ZERO 1
#endif
...
#define _nl_find_domain __libc_nl_find_domain /* bird */
struct loaded_l10nfile *_nl_find_domain PARAMS ((const char *__dirname,
						 char *__locale,
						 const char *__domainname,
					      struct binding *__domainbinding))
     internal_function;
#define _nl_load_domain __libc_nl_load_domain /* bird */
void _nl_load_domain PARAMS ((struct loaded_l10nfile *__domain,
			      struct binding *__domainbinding))
     internal_function;
#define _nl_init_domain_conv __libc_nl_init_domain_conv /* bird */
const char *_nl_init_domain_conv PARAMS ((struct loaded_l10nfile *__domain_file,
					  struct loaded_domain *__domain,
					  struct binding *__domainbinding))
     internal_function;
#define _nl_free_domain_conv __libc_nl_free_domain_conv /* bird */
void _nl_free_domain_conv PARAMS ((struct loaded_domain *__domain))
     internal_function;

#define _nl_find_msg __libc_nl_find_msg /* bird */
char *_nl_find_msg PARAMS ((struct loaded_l10nfile *domain_file,
			    struct binding *domainbinding,
			    const char *msgid, size_t *lengthp))
     internal_function;

#if defined(_LIBC) || defined(IN_INNOTEK_LIBC)
