/* $Id: locale_ctype_default.c 1763 2005-01-17 01:48:39Z bird $ */
/** @file
 *
 * Locale - ctype default data (BSD/Unix compatability).
 *
...
const __LIBC_LOCALECTYPE     __libc_GLocaleCtypeDefault =
{
    .auchUpper =
    {
...
int __isctype(__ct_rune_t __ch, unsigned __f)
{
    return !((__ch) & ~0xffU)
