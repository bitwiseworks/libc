/* $Id: sigwaitinfo.c 2254 2005-07-17 12:25:44Z bird $ */
/** @file
 *
 * LIBC - sigwaitinfo().
 *
 ...
 *                      that we accepted.
 */
int _STD(sigwaitinfo)(const sigset_t *pSigSet, siginfo_t *pSigInfo)
{
    LIBCLOG_ENTER("pSigSet=%p {%#08lx%#08lx} pSigInfo=%p\n",
     ...
     */
    rc = sigtimedwait(pSigSet, pSigInfo, NULL);
    if (rc >= 0)
