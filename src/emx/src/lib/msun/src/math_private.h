...
/* bird added: */
#define	__ieee754_log10l    log10l
#define	__ieee754_logl      logl
#define	__ieee754_expl      expl
#define	__ieee754_sinhl     sinhl
#define	__ieee754_coshl     coshl
#define	__ieee754_sqrtl     sqrtl
#define	__ieee754_atan2l    atan2l
#define	__ieee754_hypotl    hypotl
#define __ieee754_gammal    gammal
long double __ieee754_gammal(long double);
#define __ieee754_gammal_r  gammal_r
long double __ieee754_gammal_r(long double,int *);
#define __ieee754_lgammal_r lgammal_r
long double __ieee754_lgammal_r(long double, int *);
#define __ieee754_jnl jnl
long double __ieee754_jnl(int,long double);
#define __ieee754_j0l j0l
long double __ieee754_j0l(long double);
#define __ieee754_j1l j1l
long double __ieee754_j1l(long double);
#define __ieee754_y0l y0l
long double __ieee754_y0l(long double);
#define __ieee754_y1l y1l
long double __ieee754_y1l(long double);
#define __ieee754_jnl jnl
long double __ieee754_jnl(int,long double);
#define __ieee754_ynl ynl
long double __ieee754_ynl(int,long double);
#define __ieee754_acoshl acoshl
long double __ieee754_acoshl(long double);
#define __ieee754_remainderl remainderl
