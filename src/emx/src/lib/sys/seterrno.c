...
static unsigned char const errno_tab[] =
{
  ...
  E2BIG,  ENOEXEC,EINVAL, EINVAL, EINVAL,  /* 10..14 */
  ...
  ENOENT, ENOENT, ENOSYS, ECHILD, ECHILD,  /* 125..129 */
  ...
  E2BIG,  EINVAL, EINVAL, EINVAL, EAGAIN,  /* 160..164 */
  ...
  EINVAL, EINVAL, ENOSYS, EINVAL, ECHILD,  /* 180..184 */
  ...
  EEXIST, EINVAL, EBUSY, EINVAL, EINVAL,   /* 285..289 */
