...
static char *tparam1 (const char *string, char *outstring, int len, char *up, char *left, int *argp);
...
tparam (const char *string, char *outstring, int len, ...)
{
  ...
  va_list arg;
  va_start (arg, len);
  args[0] = va_arg (arg, int);
  args[1] = va_arg (arg, int);
  args[2] = va_arg (arg, int);
  args[3] = va_arg (arg, int);
  va_end (arg);
  return tparam1 (string, outstring, len, NULL, NULL, args);
}
