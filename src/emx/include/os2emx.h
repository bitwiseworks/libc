...
/* ------------------------ DISABLE KEYWORDS ------------------------------ */
#if !defined (_System) && !defined (__IBMC__) && !defined (__IBMCPP__)
#define APIENTRY
#define EXPENTRY
#else
...
#endif
#if !defined (INCL_LONGLONG_STRUCTS)
...
ULONG APIENTRY DosErrClass (ULONG ulCode, PULONG pulClass, PULONG pulAction,
    PULONG pulLocus);
ULONG APIENTRY DosError (ULONG ulError);
ULONG APIENTRY DosQueryExtLIBPATH (PCSZ pszExtLIBPATH, ULONG flags);
ULONG APIENTRY DosSetExtLIBPATH (PCSZ pszExtLIBPATH, ULONG flags);
...
#define OBJ_SELMAPALL           0x0800
#define PAG_DEFAULT		0x0400
#define PAG_SHARED		0x2000
#define PAG_FREE		0x4000
#define PAG_BASE		0x00010000

#define SEL_CODE                0x0001
#define SEL_USE32               0x0002

#define PAG_NPOUT               0x0000
#define PAG_PRESENT             0x0001
#define PAG_NPIN                0x0002
#define PAG_PRESMASK            0x0003
#define PAG_INVALID             0x0000
#define PAG_RESIDENT            0x0010
#define PAG_SWAPPABLE           0x0020
#define PAG_DISCARDABLE         0x0030
#define PAG_TYPEMASK            0x0030
...
ULONG APIENTRY DosAliasMem (CPVOID pv, ULONG cb, PPVOID ppvAlias, ULONG fl);
ULONG APIENTRY DosAllocMem (PPVOID pBaseAddress, ULONG ulObjectSize,
    ULONG ulAllocationFlags);
ULONG APIENTRY DosAllocSharedMem (PPVOID pBaseAddress, PCSZ pszName,
    ULONG ulObjectSize, ULONG ulAllocationFlags);
ULONG APIENTRY DosFreeMem (PVOID pBaseAddress);
ULONG APIENTRY DosGetNamedSharedMem (PPVOID pBaseAddress, PCSZ pszSharedMemName,
    ULONG ulAttributeFlags);
ULONG APIENTRY DosGetSharedMem (CPVOID pBaseAddress, ULONG ulAttributeFlags);
ULONG APIENTRY DosGiveSharedMem (CPVOID pBaseAddress, PID idProcessId,
    ULONG ulAttributeFlags);
ULONG APIENTRY DosQueryMem (CPVOID pBaseAddress, PULONG pulRegionSize,
    PULONG pulAllocationFlags);
ULONG APIENTRY DosQueryMemState (CPVOID pv, PULONG cb, PULONG pfl);
ULONG APIENTRY DosSetMem (CPVOID pBaseAddress, ULONG ulRegionSize,
    ULONG ulAttributeFlags);
ULONG APIENTRY DosSubAllocMem (PVOID pOffset, PPVOID pBlockOffset, ULONG ulSize);
ULONG APIENTRY DosSubFreeMem (PVOID pOffset, PVOID pBlockOffset, ULONG ulSize);
ULONG APIENTRY DosSubSetMem (PVOID pOffset, ULONG ulFlags, ULONG ulSize);
ULONG APIENTRY DosSubUnsetMem (PVOID pOffset);
...
#if 0 /* -pedantic generates annoying warnings here */
...
ULONG APIENTRY DosCancelLockRequest (HFILE hFile, __const__ FILELOCK *pfl);
ULONG APIENTRY DosCancelLockRequestL (HFILE hFile, __const__ FILELOCKL *pfl);
ULONG APIENTRY DosClose (HFILE hFile);
ULONG APIENTRY DosCopy (PCSZ pszSource, PCSZ pszTarget, ULONG ulOption);
ULONG APIENTRY DosCreateDir (PCSZ pszDirName, PEAOP2 pEABuf);
ULONG APIENTRY DosDelete (PCSZ pszFileName);
ULONG APIENTRY DosDeleteDir (PCSZ pszDirName);
ULONG APIENTRY DosDupHandle (HFILE hFile, PHFILE phFile);
ULONG APIENTRY DosEditName (ULONG ulLevel, PCSZ pszSource, PCSZ pszEdit,
    PBYTE pszTargetBuf, ULONG ulTargetBufLength);
ULONG APIENTRY DosEnumAttribute (ULONG ulRefType, CPVOID pvFile, ULONG ulEntry,
    PVOID pvBuf, ULONG ulBufLength, PULONG pulCount, ULONG ulInfoLevel);
ULONG APIENTRY DosFindClose (HDIR hDir);
ULONG APIENTRY DosFindFirst (PCSZ pszFileSpec, PHDIR phDir, ULONG flAttribute,
    PVOID pFindBuf, ULONG ulFindBufLength, PULONG pulFileNames,
    ULONG ulInfoLevel);
ULONG APIENTRY DosFindNext (HDIR hDir, PVOID pFindBuf, ULONG ulFindBufLength,
    PULONG pulFileNames);
ULONG APIENTRY DosForceDelete (PCSZ pszFileName);
ULONG APIENTRY DosFSAttach (PCSZ pszDevice, PCSZ pszFilesystem,
    __const__ VOID *pData, ULONG ulDataLength, ULONG ulFlag);
ULONG APIENTRY DosFSCtl (PVOID pData, ULONG ulDataLengthMax, PULONG pulDataLength,
    PVOID pParmList, ULONG ulParmLengthMax, PULONG pulParmLength,
    ULONG ulFunction, PCSZ pszRouteName, HFILE hFile, ULONG ulMethod);
ULONG APIENTRY DosListIO (ULONG ulCmdMode, ULONG cEntries, PLISTIO pListIO);
ULONG APIENTRY DosListIOL (ULONG ulCmdMode, ULONG cEntries, PLISTIOL pListIO);
ULONG APIENTRY DosMove (PCSZ pszOldName, PCSZ pszNewName);
ULONG APIENTRY DosOpen (PCSZ pszFileName, PHFILE phFile, PULONG pulAction,
    ULONG ulFileSize, ULONG ulAttribute, ULONG ulOpenFlags, ULONG ulOpenMode,
    PEAOP2 pEABuf);
ULONG APIENTRY DosOpenL (PCSZ pszFileName, PHFILE phFile, PULONG pulAction,
    LONGLONG llFileSize, ULONG ulAttribute, ULONG ulOpenFlags, ULONG ulOpenMode,
    PEAOP2 pEABuf);
ULONG APIENTRY DosProtectClose (HFILE hFile, FHLOCK fhFileHandleLockID);
ULONG APIENTRY DosProtectEnumAttribute (ULONG ulRefType, CPVOID pvFile,
    ULONG ulEntry, PVOID pvBuf, ULONG ulBufLength, PULONG pulCount,
    ULONG ulInfoLevel, FHLOCK fhFileHandleLockID);
ULONG APIENTRY DosProtectOpen (PCSZ pszFileName, PHFILE phFile, PULONG pulAction,
    ULONG cbFile, ULONG ulAttribute, ULONG ulOpenFlags, ULONG ulOpenMode,
    PEAOP2 pEABuf, PFHLOCK pfhFileHandleLockID);
ULONG APIENTRY DosProtectOpenL (PCSZ pszFileName, PHFILE phFile, PULONG pulAction,
    LONGLONG cbFile, ULONG ulAttribute, ULONG flOpenFlags, ULONG flOpenMode,
    PEAOP2 peaop2, PFHLOCK pfhFileHandleLockID);
ULONG APIENTRY DosProtectQueryFHState (HFILE hFile, PULONG pulMode,
    FHLOCK fhFileHandleLockID);
ULONG APIENTRY DosProtectQueryFileInfo (HFILE hFile, ULONG ulInfoLevel,
    PVOID pInfoBuffer, ULONG ulInfoLength, FHLOCK fhFileHandleLockID);
ULONG APIENTRY DosProtectRead (HFILE hFile, PVOID pBuffer, ULONG ulLength,
    PULONG pulBytesRead, FHLOCK fhFileHandleLockID);
ULONG APIENTRY DosProtectSetFHState (HFILE hFile, ULONG ulMode,
    FHLOCK fhFileHandleLockID);
ULONG APIENTRY DosProtectSetFileInfo (HFILE hFile, ULONG ulInfoLevel, PVOID pInfoBuffer,
    ULONG ulInfoLength, FHLOCK fhFileHandleLockID);
ULONG APIENTRY DosProtectSetFileLocks (HFILE hFile, __const__ FILELOCK *pflUnlock,
    __const__ FILELOCK *pflLock, ULONG ulTimeout, ULONG flFlags,
    FHLOCK fhFileHandleLockID);
ULONG APIENTRY DosProtectSetFileLocksL (HFILE hFile, __const__ FILELOCKL *pflUnlock,
    __const__ FILELOCKL *pflLock, ULONG ulTimeout, ULONG flFlags,
    FHLOCK fhFileHandleLockID);
ULONG APIENTRY DosProtectSetFilePtr (HFILE hFile, LONG lOffset, ULONG ulOrigin,
    PULONG pulPos, FHLOCK fhFileHandleLockID);
ULONG APIENTRY DosProtectSetFilePtrL (HFILE hFile, LONGLONG llOffset, ULONG ulOrigin,
    PLONGLONG pllPos, FHLOCK fhFileHandleLockID);
ULONG APIENTRY DosProtectSetFileSize (HFILE hFile, ULONG cbSize,
    FHLOCK fhFileHandleLockID);
ULONG APIENTRY DosProtectSetFileSizeL (HFILE hFile, LONGLONG cbSize,
    FHLOCK fhFileHandleLockID);
ULONG APIENTRY DosProtectWrite (HFILE hFile, CPVOID pBuffer, ULONG ulLength,
    PULONG pulBytesWritten, FHLOCK fhFileHandleLockID);
ULONG APIENTRY DosQueryCurrentDir (ULONG ulDrive, PBYTE pPath, PULONG pulPathLength);
ULONG APIENTRY DosQueryCurrentDisk (PULONG pulDrive, PULONG pulLogical);
ULONG APIENTRY DosQueryFHState (HFILE hFile, PULONG pulMode);
ULONG APIENTRY DosQueryFileInfo (HFILE hFile, ULONG ulInfoLevel, PVOID pInfoBuffer,
    ULONG ulInfoLength);
ULONG APIENTRY DosQueryFSAttach (PCSZ pszDeviceName, ULONG ulOrdinal,
    ULONG ulFSAInfoLevel, PFSQBUFFER2 pfsqb, PULONG pulBufLength);
ULONG APIENTRY DosQueryFSInfo (ULONG ulDrive, ULONG ulInfoLevel, PVOID pBuf,
    ULONG ulBufLength);
ULONG APIENTRY DosQueryHType (HFILE hFile, PULONG pulType, PULONG pulAttr);
ULONG APIENTRY DosQueryPathInfo (PCSZ pszPathName, ULONG ulInfoLevel,
    PVOID pInfoBuffer, ULONG ulInfoLength);
ULONG APIENTRY DosQueryVerify (PBOOL32 pVerify);
ULONG APIENTRY DosRead (HFILE hFile, PVOID pBuffer, ULONG ulLength,
    PULONG pulBytesRead);
ULONG APIENTRY DosResetBuffer (HFILE hf);
ULONG APIENTRY DosSetCurrentDir (PCSZ pszDir);
ULONG APIENTRY DosSetDefaultDisk (ULONG ulDrive);
ULONG APIENTRY DosSetFHState (HFILE hFile, ULONG ulMode);
ULONG APIENTRY DosSetFileInfo (HFILE hFile, ULONG ulInfoLevel, PVOID pInfoBuffer,
    ULONG ulInfoLength);
ULONG APIENTRY DosSetFileLocks (HFILE hFile, __const__ FILELOCK *pflUnlock,
    __const__ FILELOCK *pflLock, ULONG ulTimeout, ULONG ulFlags);
ULONG APIENTRY DosSetFileLocksL (HFILE hFile, __const__ FILELOCKL *pflUnlock,
    __const__ FILELOCKL *pflLock, ULONG ulTimeout, ULONG flFlags);
ULONG APIENTRY DosSetFilePtr (HFILE hFile, LONG lOffset, ULONG ulOrigin, PULONG pulPos);
ULONG APIENTRY DosSetFilePtrL (HFILE hFile, LONGLONG llOffset, ULONG ulOrigin, PLONGLONG pllPos);
ULONG APIENTRY DosSetFileSize (HFILE hFile, ULONG cbSize);
ULONG APIENTRY DosSetFileSizeL (HFILE hFile, LONGLONG cbSize);
ULONG APIENTRY DosSetFSInfo (ULONG ulDrive, ULONG ulInfoLevel, PVOID pBuf,
    ULONG ulBufLength);
ULONG APIENTRY DosSetMaxFH (ULONG ulCount);
ULONG APIENTRY DosSetPathInfo (PCSZ pszPathName, ULONG ulInfoLevel, PVOID pInfoBuffer,
    ULONG ulInfoLength, ULONG ulOptions);
ULONG APIENTRY DosSetRelMaxFH (PLONG pulReqCount, PULONG pulCurMaxFH);
ULONG APIENTRY DosSetVerify (BOOL32 f32Verify);
ULONG APIENTRY DosShutdown (ULONG ulReserved);
ULONG APIENTRY DosWrite (HFILE hFile, CPVOID pBuffer, ULONG ulLength,
...
#if defined (INCL_DOSMISC)
ULONG APIENTRY DosSearchPath (ULONG ulControl, PCSZ pszPath, PCSZ pszFilename,
...
ULONG APIENTRY DosDevConfig (PVOID pInfo, ULONG ulItem);
ULONG APIENTRY DosDevIOCtl (HFILE hDevice, ULONG ulCategory, ULONG ulFunction,
    PVOID pParams, ULONG ulParamsLengthMax, PULONG pulParamsLength,
    PVOID pData, ULONG ulDataLengthMax, PULONG pulDataLength);
ULONG APIENTRY DosPhysicalDisk (ULONG ulFunction, PVOID pBuffer, ULONG ulBufferLength,
...
ULONG APIENTRY DosMapCase (ULONG ulLength, __const__ COUNTRYCODE *pCountryCode,
    PCHAR pchString);
ULONG APIENTRY DosQueryCollate (ULONG ulLength, __const__ COUNTRYCODE *pCountryCode,
    PCHAR pchBuffer, PULONG pulDataLength);
ULONG APIENTRY DosQueryCp (ULONG ulLength, PULONG pCodePageList, PULONG pDataLength);
ULONG APIENTRY DosQueryCtryInfo (ULONG ulLength, PCOUNTRYCODE pCountryCode,
    PCOUNTRYINFO pCountryInfo, PULONG pulDataLength);
ULONG APIENTRY DosQueryDBCSEnv (ULONG ulLength, PCOUNTRYCODE pCountryCode, PCHAR pBuf);
ULONG APIENTRY DosSetProcessCp (ULONG ulCodePage);
...
ULONG APIENTRY DosFreeModule (HMODULE hmod);
ULONG APIENTRY DosLoadModule (PSZ pszObject, ULONG uObjectLen, PCSZ pszModule,
    PHMODULE phmod);
ULONG APIENTRY DosQueryModuleHandle (PCSZ pszModname, PHMODULE phmod);
ULONG APIENTRY DosQueryModuleName (HMODULE hmod, ULONG ulNameLength, PCHAR pNameBuf);
ULONG APIENTRY DosQueryProcAddr (HMODULE hmod, ULONG ulOrdinal, PCSZ pszProcName,
    PPFN pProcAddr);
ULONG APIENTRY DosQueryProcType (HMODULE hmod, ULONG ulOrdinal, PCSZ pszProcName,
    PULONG pulProcType);
ULONG APIENTRY DosQueryModFromEIP (PHMODULE phmod, PULONG piObject, ULONG cbBuff,
    PCHAR pchBuff, PULONG offObject, ULONG ulEIP);
ULONG APIENTRY DosQueryABIOSSupport (ULONG ulReserved);
ULONG APIENTRY DosReplaceModule (PCSZ pszOldModule, PCSZ pszNewModule, PCSZ pszBackupModule);
...
ULONG APIENTRY DosFreeResource (PVOID pResAddr);
ULONG APIENTRY DosGetResource (HMODULE hmod, ULONG ulTypeID, ULONG ulNameID,
    PPVOID pOffset);
ULONG APIENTRY DosQueryResourceSize (HMODULE hmod, ULONG ulTypeID, ULONG ulNameID,
    PULONG pulSize);
...
ULONG APIENTRY DosBeep (ULONG ulFrequency, ULONG ulDuration);
VOID APIENTRY DosExit (ULONG ulAction, ULONG ulResult) __attribute__ ((__noreturn__));
...
#ifdef OS2EMX_UNSTRICT
typedef VOID FNTHREAD(ULONG ulThreadArg);
#else
typedef VOID APIENTRY FNTHREAD(ULONG ulThreadArg);
#endif
typedef FNTHREAD *PFNTHREAD;

#ifdef OS2EMX_UNSTRICT
typedef VOID FNEXITLIST(ULONG ulArg);
#else
typedef VOID APIENTRY FNEXITLIST(ULONG ulArg);
#endif
...
ULONG APIENTRY DosAllocThreadLocalMemory (ULONG cb, PULONG *p);
ULONG APIENTRY DosCreateThread (PTID ptidThreadID, PFNTHREAD pfnThreadAddr,
    ULONG ulThreadArg, ULONG ulFlags, ULONG ulStackSize);
ULONG APIENTRY DosCreateThread2 (PTHREADCREATE ptc);
ULONG APIENTRY DosEnterCritSec (VOID);
ULONG APIENTRY DosExecPgm (PCHAR pObjname, LONG lObjnameLength, ULONG ulFlagS,
    PCSZ pszArg, PCSZ pszEnv, PRESULTCODES pReturnCodes, PCSZ pszName);
ULONG APIENTRY DosExitCritSec (VOID);
ULONG APIENTRY DosExitList (ULONG ulOrder, PFNEXITLIST pfn);
ULONG APIENTRY DosFreeThreadLocalMemory (ULONG *p);
ULONG APIENTRY DosGetInfoBlocks (PTIB *ptib, PPIB *ppib);
ULONG APIENTRY DosKillProcess (ULONG ulAction, PID pid);
ULONG APIENTRY DosKillThread (TID tid);
ULONG APIENTRY DosQueryThreadAffinity (ULONG ulScope, PMPAFFINITY pAffinity);
ULONG APIENTRY DosResumeThread (TID tid);
ULONG APIENTRY DosSetPriority (ULONG ulScope, ULONG ulClass, LONG lDelta, ULONG ulID);
ULONG APIENTRY DosSetThreadAffinity (PMPAFFINITY pAffinity);
ULONG APIENTRY DosSleep (ULONG ulInterval);
ULONG APIENTRY DosSuspendThread (TID tid);
ULONG APIENTRY DosVerifyPidTid (PID pid, TID tid);
ULONG APIENTRY DosWaitChild (ULONG ulAction, ULONG ulWait, PRESULTCODES pReturnCodes,
    PPID ppidOut, PID pidIn);
ULONG APIENTRY DosWaitThread (PTID ptid, ULONG ulWait);
...
#define EAT_APPTYP_PMAPI        0
#define EAT_APPTYP_DOS          1
#define EAT_APPTYP_PMW          2
#define EAT_APPTYP_NOPMW        3
#define EAT_APPTYP_EXETYPE      3
...
ULONG APIENTRY DosQueryAppType (PCSZ pszName, PULONG pulFlags);
ULONG APIENTRY DosSelectSession (ULONG ulIDSession);
ULONG APIENTRY DosSetSession (ULONG ulIDSession, PSTATUSDATA psd);
ULONG APIENTRY DosStartSession (PSTARTDATA psd, PULONG pulIDSession, PPID ppid);
ULONG APIENTRY DosStopSession (ULONG ulScope, ULONG ulIDSession);
...
ULONG APIENTRY DosCloseEventSem (HEV hev);
ULONG APIENTRY DosCreateEventSem (PCSZ pszName, PHEV phev, ULONG ulAttr, BOOL32 fState);
ULONG APIENTRY DosOpenEventSem (PCSZ pszName, PHEV phev);
ULONG APIENTRY DosPostEventSem (HEV hev);
ULONG APIENTRY DosQueryEventSem (HEV hev, PULONG pulCount);
ULONG APIENTRY DosResetEventSem (HEV hev, PULONG pulCount);
ULONG APIENTRY DosWaitEventSem (HEV hev, ULONG ulTimeout);

ULONG APIENTRY DosCloseMutexSem (HMTX hmtx);
ULONG APIENTRY DosCreateMutexSem (PCSZ pszName, PHMTX phmtx, ULONG ulAttr,
    BOOL32 fState);
ULONG APIENTRY DosOpenMutexSem (PCSZ pszName, PHMTX phmtx);
ULONG APIENTRY DosQueryMutexSem (HMTX hmtx, PPID ppid, PTID ptid, PULONG pulCount);
ULONG APIENTRY DosReleaseMutexSem (HMTX hmtx);
ULONG APIENTRY DosRequestMutexSem (HMTX hmtx, ULONG ulTimeout);

ULONG APIENTRY DosAddMuxWaitSem (HMUX hmux, PSEMRECORD pSemRec);
ULONG APIENTRY DosCloseMuxWaitSem (HMUX hmux);
ULONG APIENTRY DosCreateMuxWaitSem (PCSZ pszName, PHMUX phmux, ULONG ulcSemRec,
    PSEMRECORD pSemRec, ULONG ulAttr);
ULONG APIENTRY DosDeleteMuxWaitSem (HMUX hmux, HSEM hSem);
ULONG APIENTRY DosOpenMuxWaitSem (PCSZ pszName, PHMUX phmux);
ULONG APIENTRY DosQueryMuxWaitSem (HMUX hmux, PULONG pulcSemRec, PSEMRECORD pSemRec,
    PULONG pulAttr);
ULONG APIENTRY DosWaitMuxWaitSem (HMUX hmux, ULONG ulTimeout, PULONG pulUser);
...
ULONG APIENTRY DosCallNPipe (PCSZ pszName, PVOID pInbuf, ULONG ulInbufLength,
    PVOID pOutbuf, ULONG ulOutbufSize, PULONG pulActualLength,
    ULONG ulTimeout);
ULONG APIENTRY DosConnectNPipe (HPIPE hpipe);
ULONG APIENTRY DosCreateNPipe (PCSZ pszName, PHPIPE phpipe, ULONG ulOpenMode,
    ULONG ulPipeMode, ULONG ulInbufLength, ULONG ulOutbufLength,
    ULONG ulTimeout);
ULONG APIENTRY DosDisConnectNPipe (HPIPE hpipe);
ULONG APIENTRY DosPeekNPipe (HPIPE hpipe, PVOID pBuf, ULONG ulBufLength,
    PULONG pulActualLength, PAVAILDATA pAvail, PULONG pulState);
ULONG APIENTRY DosQueryNPHState (HPIPE hpipe, PULONG pulState);
ULONG APIENTRY DosQueryNPipeInfo (HPIPE hpipe, ULONG ulInfoLevel, PVOID pBuf,
    ULONG ulBufLength);
ULONG APIENTRY DosQueryNPipeSemState (HSEM hsem, PPIPESEMSTATE pState,
    ULONG ulBufLength);
ULONG APIENTRY DosRawReadNPipe (PCSZ pszName, ULONG ulCount, PULONG pulLength,
    PVOID pBuf);
ULONG APIENTRY DosRawWriteNPipe (PCSZ pszName, ULONG ulCount);
ULONG APIENTRY DosSetNPHState (HPIPE hpipe, ULONG ulState);
ULONG APIENTRY DosSetNPipeSem (HPIPE hpipe, HSEM hsem, ULONG ulKey);
ULONG APIENTRY DosTransactNPipe (HPIPE hpipe, PVOID pOutbuf, ULONG ulOutbufLength,
    PVOID pInbuf, ULONG ulInbufLength, PULONG pulBytesRead);
ULONG APIENTRY DosWaitNPipe (PCSZ pszName, ULONG ulTimeout);
...
ULONG APIENTRY DosCreatePipe (PHFILE phfReadHandle, PHFILE phfWriteHandle,
    ULONG ulPipeSize);

ULONG APIENTRY DosCloseQueue (HQUEUE hq);
ULONG APIENTRY DosCreateQueue (PHQUEUE phq, ULONG ulPriority, PCSZ pszName);
ULONG APIENTRY DosOpenQueue (PPID ppid, PHQUEUE phq, PCSZ pszName);
ULONG APIENTRY DosPeekQueue (HQUEUE hq, PREQUESTDATA pRequest, PULONG pulDataLength,
    PPVOID pDataAddress, PULONG pulElement, BOOL32 fNowait, PBYTE pPriority,
    HEV hsem);
ULONG APIENTRY DosPurgeQueue (HQUEUE hq);
ULONG APIENTRY DosQueryQueue (HQUEUE hq, PULONG pulCount);
ULONG APIENTRY DosReadQueue (HQUEUE hq, PREQUESTDATA pRequest, PULONG pulDataLength,
    PPVOID pDataAddress, ULONG pulElement, BOOL32 fNowait, PBYTE pPriority,
    HEV hsem);
ULONG APIENTRY DosWriteQueue (HQUEUE hq, ULONG ulRequest, ULONG ulDataLength,
...
#else
typedef ULONG APIENTRY _ERR (PEXCEPTIONREPORTRECORD pReport,
		    struct _EXCEPTIONREGISTRATIONRECORD *pRegistration,
		    PCONTEXTRECORD pContext, PVOID pWhatever);
#endif
typedef _ERR *ERR;
...
ULONG APIENTRY DosAcknowledgeSignalException (ULONG ulSignal);
ULONG APIENTRY DosEnterMustComplete (PULONG pulNesting);
ULONG APIENTRY DosExitMustComplete (PULONG pulNesting);
ULONG APIENTRY DosQueryThreadContext (TID tid, ULONG ulLevel, PCONTEXTRECORD pContext);
ULONG APIENTRY DosRaiseException (PEXCEPTIONREPORTRECORD pXRepRec);
ULONG APIENTRY DosSendSignalException (PID pid, ULONG ulSignal);
ULONG APIENTRY DosSetExceptionHandler (PEXCEPTIONREGISTRATIONRECORD pXRegRec);
ULONG APIENTRY DosSetSignalExceptionFocus (BOOL32 flag, PULONG pulTimes);
ULONG APIENTRY DosUnsetExceptionHandler (PEXCEPTIONREGISTRATIONRECORD pXRegRec);
ULONG APIENTRY DosUnwindException (PEXCEPTIONREGISTRATIONRECORD pXRegRec,
...
#if defined (INCL_DOSSIGNALS) && !defined(INCL_NO16BIT)
...
typedef VOID (/* far 16-bit pascal */ *PFNSIGHANDLER)(USHORT, USHORT);
...
USHORT APIENTRY DosFlagProcess (PID pid, USHORT fusScope, USHORT usFlagNum, USHORT usFlagArg);
...
ULONG APIENTRY DosQuerySysInfo (ULONG ulStart, ULONG ulLast, PVOID pBuf,
    ULONG ulBufLength);
ULONG APIENTRY DosScanEnv (PCSZ pszName, PSZ *pszValue);
ULONG APIENTRY DosQueryRASInfo (ULONG Index, PPVOID Addr);
...
ULONG APIENTRY DosGetDateTime (PDATETIME pdt);
ULONG APIENTRY DosSetDateTime (__const__ DATETIME *pdt);
...
ULONG APIENTRY DosAsyncTimer (ULONG ulMilliSec, HSEM hsem, PHTIMER phtimer);
ULONG APIENTRY DosStartTimer (ULONG ulMilliSec, HSEM hsem, PHTIMER phtimer);
ULONG APIENTRY DosStopTimer (HTIMER htimer);
...
typedef QSS16HEADREC qsS16Headrec_t;
...
typedef QSPTRREC qsPtrRec_t;

ULONG APIENTRY DosAliasPerfCtrs (ULONG ulRangeType, ULONG ulInfo,
    PBYTE *ppbRangeStart, ULONG *pulRangeSize);
ULONG APIENTRY DosConfigurePerf (ULONG ulEntityType, ULONG ulConfigType,
    ULONG ulInfo1, ULONG ulInfo2, PCSZ  pszConfigSpec, BOOL32 fExclude);
ULONG APIENTRY DosDeconPerf (VOID);
ULONG APIENTRY DosPerfSysCall (ULONG ulCommand, ULONG ulParm1, ULONG ulParm2,
    ULONG ulParm3);
ULONG APIENTRY DosQuerySysState (ULONG ulEntityList, ULONG ulEntityLevel,
    PID pid, TID tid, PVOID pvDataBuf, ULONG cbBuf);
ULONG APIENTRY DosRegisterPerfCtrs (PBYTE pbDataBlk, PBYTE pbTextBlk, ULONG flFlags);
ULONG APIENTRY DosTmrQueryFreq (PULONG pulTmrFreq);
ULONG APIENTRY DosTmrQueryTime (PQWORD pqwTmrTime);
...
ULONG APIENTRY DosCloseVDD (HVDD hvdd);
ULONG APIENTRY DosOpenVDD (PCSZ pszVDD, PHVDD phvdd);
ULONG APIENTRY DosQueryDOSProperty (SGID sgidSesssionID, PCSZ pszName,
    ULONG ulBufferLength, PSZ pBuffer);
ULONG APIENTRY DosRequestVDD (HVDD hvdd, SGID sgidSessionID, ULONG ulCommand,
    ULONG ulInputBufferLength, PVOID pInputBuffer,
    ULONG ulOutputBufferLength, PVOID pOutputBuffer);
ULONG APIENTRY DosSetDOSProperty (SGID sgidSessionID, PCSZ pszName,
...
ULONG APIENTRY DosCreateSpinLock (PHSPINLOCK pHandle);
ULONG APIENTRY DosFreeSpinLock (HSPINLOCK hSpinLock);
ULONG APIENTRY DosGetProcessorStatus (ULONG ulProcNum, PULONG pStatus);
ULONG APIENTRY DosGetProcessorStatus (ULONG ulProcid, PULONG pulStatus);
ULONG APIENTRY DosPerfSysCall (ULONG ulCommand, ULONG ulParm1, ULONG ulParm2, ULONG ulParm3);
ULONG APIENTRY DosSetProcessorStatus (ULONG ulProcNum, ULONG pStatus);
ULONG APIENTRY DosSetProcessorStatus (ULONG ulProcid, ULONG ulStatus);
ULONG APIENTRY DosTestPSD (PCSZ pszPSDFileName);
...
ULONG APIENTRY DosDebug (uDB_t *pDebugBuffer);
...
ULONG APIENTRY DosGetMessage (PCHAR *pTable, ULONG ulTableEntries,
    PCHAR pBuffer, ULONG ulBufferLengthMax, ULONG ulMsgnNumber,
    PCSZ pszFile, PULONG pulBufferLength);
ULONG APIENTRY DosInsertMessage (PCHAR *pTable, ULONG ulCount, PCSZ pszMsg,
    ULONG ulMsgLength, PCHAR pBuffer, ULONG ulBufferLengthMax,
    PULONG pulBufferLength);
ULONG APIENTRY DosPutMessage (HFILE hfile, ULONG ulMessageLength, PCHAR pMessage);
ULONG APIENTRY DosQueryMessageCP (PCHAR pBuffer, ULONG ulBufferLengthMax,
...
ULONG APIENTRY DosDumpProcess (ULONG ulFlag, ULONG ulDrive, PID pid);
ULONG APIENTRY DosForceSystemDump (ULONG ulReserved);
ULONG APIENTRY DosQueryRASInfo (ULONG ulIndex, PPVOID addr);
ULONG APIENTRY DosSuppressPopUps (ULONG ulFlag, ULONG ulDrive);

#endif /* INCL_DOSRAS */

/* ---------------------------- REXX -------------------------------------- */

#if defined (INCL_RXSUBCOM) || defined (INCL_RXSHV) || defined (INCL_RXFUNC) || defined (INCL_RXSYSEXIT) || defined (INCL_RXMACRO) || defined (INCL_RXARI)
...
typedef ULONG RexxSubcomHandler (PRXSTRING prxCommand, PUSHORT pusFlags,
    PRXSTRING prxResult);
#else
typedef ULONG APIENTRY RexxSubcomHandler (PRXSTRING prxCommand, PUSHORT pusFlags,
    PRXSTRING prxResult);
#endif

ULONG APIENTRY RexxDeregisterSubcom (PCSZ pszEnvName, PCSZ pszModuleName);
ULONG APIENTRY RexxQuerySubcom (PCSZ pszEnvName, PCSZ pszModuleName, PUSHORT pusFlags,
    PUCHAR pUserWord);
ULONG APIENTRY RexxRegisterSubcomDll (PCSZ pszEnvName, PCSZ pszModuleName,
    PCSZ pszEntryPoint, PUCHAR pUserArea, ULONG ulDropAuth);
ULONG APIENTRY RexxRegisterSubcomExe (PCSZ pszEnvName, PFN pfnEntryPoint,
    PUCHAR pUserArea);
...
ULONG APIENTRY RexxVariablePool (PSHVBLOCK pRequest);
...
#else
typedef ULONG APIENTRY RexxFunctionHandler (PCSZ pszName, ULONG ulArgCount,
    PRXSTRING prxArgList, PCSZ pszQueueName, PRXSTRING prxResult);
#endif

ULONG APIENTRY RexxDeregisterFunction (PCSZ pszFuncName);
ULONG APIENTRY RexxQueryFunction (PCSZ pszFuncName);
ULONG APIENTRY RexxRegisterFunctionDll (PCSZ pszFuncName, PCSZ pszModuleName,
    PCSZ pszEntryPoint);
ULONG APIENTRY RexxRegisterFunctionExe (PCSZ pszFuncName,
...
typedef LONG RexxExitHandler (LONG lExitNumber, LONG lSubfunction,
    PEXIT pParmBlock);
#else
typedef LONG APIENTRY RexxExitHandler (LONG lExitNumber, LONG lSubfunction,
    PEXIT pParmBlock);
#endif

ULONG APIENTRY RexxDeregisterExit (PCSZ pszEnvName, PCSZ pszModuleName);
ULONG APIENTRY RexxQueryExit (PCSZ pszEnvName, PCSZ pszModuleName, PUSHORT pusFlag,
    PUCHAR pUserWord);
ULONG APIENTRY RexxRegisterExitDll (PCSZ pszEnvName, PCSZ pszModuleName,
    PCSZ pszEntryName, PUCHAR pUserArea, ULONG ulDropAuth);
ULONG APIENTRY RexxRegisterExitExe (PCSZ pszEnvName, PFN pfnEntryPoint,
    PUCHAR pUserArea);
...
ULONG APIENTRY RexxResetTrace (PID pid, TID tid);
ULONG APIENTRY RexxSetHalt (PID pid, TID tid);
ULONG APIENTRY RexxSetTrace (PID pid, TID tid);
...
ULONG APIENTRY RexxAddMacro (PCSZ pszFuncName, PCSZ pszSourceFile, ULONG ulPosition);
ULONG APIENTRY RexxClearMacroSpace (VOID);
ULONG APIENTRY RexxDropMacro (PCSZ pszFuncName);
ULONG APIENTRY RexxLoadMacroSpace (ULONG ulFuncCout, PCSZ *apszFuncNames,
    PCSZ pszMacroLibFile);
ULONG APIENTRY RexxQueryMacro (PCSZ pszFuncName, PUSHORT pusPosition);
ULONG APIENTRY RexxReorderMacro(PCSZ pszFuncName, ULONG ulPosition);
ULONG APIENTRY RexxSaveMacroSpace (ULONG ulFuncCount, PCSZ *apszFuncNames,
    PCSZ pszMacroLibFile);
...
LONG APIENTRY RexxStart (LONG lArgCount, PRXSTRING prxArgList, PCSZ pszProgramName,
...
#else
typedef MRESULT (EXPENTRY FNWP) (HWND hwnd, ULONG msg, MPARAM mp1, MPARAM mp2);
#endif
typedef FNWP *PFNWP;
...
HMQ APIENTRY WinCreateMsgQueue (HAB hab, LONG cmsg);
BOOL APIENTRY WinDestroyMsgQueue (HMQ hmq);
MRESULT APIENTRY WinDispatchMsg (HAB hab, PQMSG pqmsg);
BOOL APIENTRY WinGetMsg (HAB hab, PQMSG pqmsg, HWND hwndFilter, ULONG msgFilterFirst,
    ULONG msgFilterLast);
BOOL APIENTRY WinLockInput (HMQ hmq, ULONG fLock);
BOOL APIENTRY WinPeekMsg (HAB hab, PQMSG pqmsg, HWND hwndFilter, ULONG msgFilterFirst,
...
BOOL APIENTRY WinRegisterUserDatatype (HAB hab, LONG datatype, LONG count, PLONG types);
BOOL APIENTRY WinRegisterUserMsg (HAB hab, ULONG msgid, LONG datatype1, LONG dir1,
    LONG datatype2, LONG dir2, LONG datatyper);
BOOL APIENTRY WinReplyMsg (HAB hab, HMQ hmqSender, HMQ hmqReceiver, MRESULT mresult);
MRESULT APIENTRY WinSendMsg (HWND hwnd, ULONG msg, MPARAM mp1, MPARAM mp2);
BOOL APIENTRY WinSetMsgMode (HAB hab, PCSZ classname, LONG control);
BOOL APIENTRY WinSetSynchroMode (HAB hab, LONG mode);
...
HWND APIENTRY WinCreateWindow (HWND hwndParent, PCSZ pszClass, PCSZ pszName,
...
BOOL APIENTRY WinDrawBitmap (HPS hpsDst, HBITMAP hbm, __const__ RECTL *pwrcSrc,
    __const__ POINTL *pptlDst, LONG clrFore, LONG clrBack, ULONG fl);
BOOL APIENTRY WinDrawBorder (HPS hps, __const__ RECTL *prcl, LONG cx, LONG cy,
    LONG clrFore, LONG clrBack, ULONG flCmd);
LONG APIENTRY WinDrawText (HPS hps, LONG cchText, PCCH lpchText, PRECTL prcl,
    LONG clrFore, LONG clrBack, ULONG flCmd);
BOOL APIENTRY WinEnableWindow (HWND hwnd, BOOL fEnable);
BOOL APIENTRY WinEnableWindowUpdate (HWND hwnd, BOOL fEnable);
BOOL APIENTRY WinInvalidateRect (HWND hwnd, __const__ RECTL *prcl,
    BOOL fIncludeChildren);
BOOL APIENTRY WinInvalidateRegion (HWND hwnd, HRGN hrgn, BOOL fIncludeChildren);
BOOL APIENTRY WinInvertRect (HPS hps, __const__ RECTL *prcl);
...
LONG APIENTRY WinLoadMessage (HAB hab, HMODULE hmod, ULONG id, LONG cchMax,
    PSZ pchBuffer);
LONG APIENTRY WinLoadString (HAB hab, HMODULE hmod, ULONG id, LONG cchMax,
    PSZ pchBuffer);
LONG APIENTRY WinMultWindowFromIDs (HWND hwndParent, PHWND prghwnd, ULONG idFirst,
    ULONG idLast);
...
LONG APIENTRY WinQueryWindowText (HWND hwnd, LONG cchBufferMax, PCH pchBuffer);
LONG APIENTRY WinQueryWindowTextLength (HWND hwnd);
BOOL APIENTRY WinSetMultWindowPos (HAB hab, __const__ SWP *pswp, ULONG cswp);
...
BOOL APIENTRY WinGetMinPosition (HWND hwnd, PSWP pswp, __const__ POINTL *pptl);
BOOL APIENTRY WinSaveWindowPos (HSAVEWP hsvwp, PSWP pswp, ULONG cswp);
...
MRESULT APIENTRY WinDefWindowProc (HWND hwnd, ULONG msg, MPARAM mp1, MPARAM mp2);
BOOL APIENTRY WinDestroyWindow (HWND hwnd);
BOOL APIENTRY WinEndPaint (HPS hps);
BOOL APIENTRY WinFillRect (HPS hps, __const__ RECTL *prcl, LONG lColor);
HPS APIENTRY WinGetClipPS (HWND hwnd, HWND hwndClip, ULONG fl);
...
LONG APIENTRY WinScrollWindow (HWND hwnd, LONG dx, LONG dy, __const__ RECTL *prclScroll,
...
BOOL APIENTRY WinQueryClassInfo (HAB hab, PCSZ pszClassName, PCLASSINFO pClassInfo);
LONG APIENTRY WinQueryClassName (HWND hwnd, LONG cchMax, PCH pch);
...
BOOL APIENTRY WinSetWindowPtr (HWND hwnd, LONG index, PVOID p);
...
BOOL APIENTRY WinValidateRect (HWND hwnd, __const__ RECTL *prcl, BOOL fIncludeChildren);
BOOL APIENTRY WinValidateRegion (HWND hwnd, HRGN hrgn, BOOL fIncludeChildren);
HWND APIENTRY WinWindowFromDC (HDC hdc);
HWND APIENTRY WinWindowFromPoint (HWND hwnd, __const__ POINTL *pptl, BOOL fChildren);
...
ULONG APIENTRY WinCopyAccelTable (HACCEL haccel, PACCELTABLE pAccelTable,
    ULONG cbCopyMax);
HACCEL APIENTRY WinCreateAccelTable (HAB hab, PACCELTABLE pAccelTable);
BOOL APIENTRY WinDestroyAccelTable (HACCEL haccel);
HACCEL APIENTRY WinLoadAccelTable (HAB hab, HMODULE hmod, ULONG idAccelTable);
...
BOOL APIENTRY WinTranslateAccel (HAB hab, HWND hwnd, HACCEL haccel, PQMSG pqmsg);
...
ATOM APIENTRY WinAddAtom (HATOMTBL hAtomTbl, PCSZ pszAtomName);
HATOMTBL APIENTRY WinCreateAtomTable (ULONG cbInitial, ULONG cBuckets);
ATOM APIENTRY WinDeleteAtom (HATOMTBL hAtomTbl, ATOM atom);
HATOMTBL APIENTRY WinDestroyAtomTable (HATOMTBL hAtomTbl);
ATOM APIENTRY WinFindAtom (HATOMTBL hAtomTbl, PCSZ pszAtomName);
ULONG APIENTRY WinQueryAtomLength (HATOMTBL hAtomTbl, ATOM atom);
ULONG APIENTRY WinQueryAtomName (HATOMTBL hAtomTbl, ATOM atom, PSZ pchBuffer,
    ULONG cchBufferMax);
ULONG APIENTRY WinQueryAtomUsage (HATOMTBL hAtomTbl, ATOM atom);
...
#define BS_CHECKBOX			0x0001
#define BS_AUTOCHECKBOX			0x0002
#define BS_RADIOBUTTON			0x0003
#define BS_AUTORADIOBUTTON		0x0004
#define BS_3STATE			0x0005
#define BS_AUTO3STATE			0x0006
#define BS_USERBUTTON			0x0007
#define BS_NOTEBOOKBUTTON               0x0008
...
BOOL APIENTRY WinDdeInitiate (HWND hwndClient, PCSZ pszAppName, PCSZ pszTopicName,
    __const__ CONVCONTEXT *pcctxt);
BOOL APIENTRY WinDdePostMsg (HWND hwndTo, HWND hwndFrom, ULONG wm,
    __const__ DDESTRUCT *pddest, ULONG flOptions);
MRESULT APIENTRY WinDdeRespond (HWND hwndClient, HWND hwndServer, PCSZ pszAppName,
...
ULONG APIENTRY WinCompareStrings (HAB hab, ULONG idcp, ULONG idcc, PCSZ psz1,
    PCSZ psz2, ULONG reserved);
UCHAR APIENTRY WinCpTranslateChar (HAB hab, ULONG cpSrc, UCHAR chSrc, ULONG cpDst);
BOOL APIENTRY WinCpTranslateString (HAB hab, ULONG cpSrc, PCSZ pszSrc, ULONG cpDst,
    ULONG cchDestMax, PSZ pchDest);
PSZ APIENTRY WinNextChar (HAB hab, ULONG idcp, ULONG idcc, PCSZ psz);
PSZ APIENTRY WinPrevChar (HAB hab, ULONG idcp, ULONG idcc, PCSZ pszStart,
    PCSZ psz);
...
ULONG APIENTRY WinUpper (HAB hab, ULONG idcp, ULONG idcc, PSZ psz);
...
BOOL APIENTRY WinCreateCursor (HWND hwnd, LONG x, LONG y, LONG cx, LONG cy,
...
HBITMAP APIENTRY WinSetDesktopBkgnd (HWND hwndDesktop, __const__ DESKTOP *pdskNew);
...
ULONG APIENTRY WinDlgBox (HWND hwndParent, HWND hwndOwner, PFNWP pfnDlgProc,
...
HWND APIENTRY WinLoadDlg (HWND hwndParent, HWND hwndOwner, PFNWP pfnDlgProc,
    HMODULE hmod, ULONG idDlg, PVOID pCreateParams);
ULONG APIENTRY WinMessageBox (HWND hwndParent, HWND hwndOwner, PCSZ pszText,
    PCSZ pszCaption, ULONG idWindow, ULONG flStyle);
ULONG APIENTRY WinMessageBox2 (HWND hwndParent, HWND hwndOwner, PCSZ pszText,
    PCSZ pszCaption, ULONG idWindow, PMB2INFO pmb2info);
BOOL APIENTRY WinQueryDlgItemShort (HWND hwndDlg, ULONG idItem, PSHORT pResult,
    BOOL fSigned);
ULONG APIENTRY WinQueryDlgItemText (HWND hwndDlg, ULONG idItem, LONG cchBufferMax,
    PSZ pchBuffer);
LONG APIENTRY WinQueryDlgItemTextLength (HWND hwndDlg, ULONG idItem);
BOOL APIENTRY WinSetDlgItemShort (HWND hwndDlg, ULONG idItem, USHORT usValue,
    BOOL fSigned);
...
BOOL APIENTRY WinMapDlgPoints (HWND hwndDlg, PPOINTL prgwptl, ULONG cwpt,
    BOOL fCalcWindowCoords);
ULONG APIENTRY WinProcessDlg (HWND hwndDlg);
MRESULT APIENTRY WinSendDlgItemMsg (HWND hwndDlg, ULONG idItem, ULONG msg,
    MPARAM mp1, MPARAM mp2);
LONG APIENTRY WinSubstituteStrings (HWND hwnd, PCSZ pszSrc, LONG cchDstMax,
    PSZ pszDst);
...
BOOL APIENTRY WinCallMsgFilter (HAB hab, PQMSG pqmsg, ULONG msgf);
BOOL APIENTRY WinReleaseHook (HAB hab, HMQ hmq, LONG iHook, PFN pfnHook, HMODULE hmod);
BOOL APIENTRY WinSetHook (HAB hab, HMQ hmq, LONG iHook, PFN pfnHook, HMODULE hmod);
...
BOOL APIENTRY WinFocusChange (HWND hwndDesktop, HWND hwndSetFocus, ULONG flFocusChange);
BOOL APIENTRY WinLockupSystem (HAB hab);
BOOL APIENTRY WinSetFocus (HWND hwndDesktop, HWND hwndSetFocus);
BOOL APIENTRY WinUnlockSystem (HAB hab, PCSZ pszPassword);
...
BOOL APIENTRY WinSetKeyboardStateTable (HWND hwndDesktop, PBYTE pKeyStateTable,
    BOOL fSet);
...
HLIB APIENTRY WinLoadLibrary (HAB hab, PCSZ libname);
...
HWND APIENTRY WinCreateMenu (HWND hwndParent, CPVOID lpmt);
...
BOOL APIENTRY WinBroadcastMsg (HWND hwnd, ULONG msg, MPARAM mp1, MPARAM mp2, ULONG rgf);
...
ULONG APIENTRY WinRequestMutexSem (HMTX hmtx, ULONG ulTimeout);
BOOL APIENTRY WinSetClassMsgInterest (HAB hab, PCSZ pszClassName, ULONG msg_class,
    LONG control);
BOOL APIENTRY WinSetMsgInterest (HWND hwnd, ULONG msg_class, LONG control);
ULONG APIENTRY WinWaitEventSem (HEV hev, ULONG ulTimeout);
BOOL APIENTRY WinWaitMsg (HAB hab, ULONG msgFirst, ULONG msgLast);
ULONG APIENTRY WinWaitMuxWaitSem (HMUX hmux, ULONG ulTimeout, PULONG pulUser);
...
LONG APIENTRY WinRealizePalette (HWND hwnd, HPS hps, PULONG pcclr);
...
HPOINTER APIENTRY WinCreatePointer (HWND hwndDesktop, HBITMAP hbmPointer, BOOL fPointer,
...
BOOL APIENTRY WinDrawPointer (HPS hps, LONG x, LONG y, HPOINTER hptr, ULONG fs);
...
BOOL APIENTRY WinLockPointerUpdate (HWND hwndDesktop, HPOINTER hptrNew,
    ULONG ulTimeInterval);
BOOL APIENTRY WinQueryPointerPos (HWND hwndDesktop, PPOINTL pptl);
BOOL APIENTRY WinQueryPointerInfo (HPOINTER hptr, PPOINTERINFO pPointerInfo);
HPOINTER APIENTRY WinQuerySysPointer (HWND hwndDesktop, LONG lId, BOOL fCopy);
BOOL APIENTRY WinQuerySysPointerData (HWND hwndDesktop, ULONG ulId,
    PICONINFO pIconInfo);
...
BOOL APIENTRY WinSetPointerPos (HWND hwndDesktop, LONG x, LONG y);
BOOL APIENTRY WinSetSysPointerData (HWND hwndDesktop, ULONG ulId,
...
BOOL APIENTRY WinCopyRect (HAB hab, PRECTL prclDst, __const__ RECTL *prclSrc);
BOOL APIENTRY WinEqualRect (HAB hab, __const__ RECTL *prcl1, __const__ RECTL *prcl2);
BOOL APIENTRY WinInflateRect (HAB hab, PRECTL prcl, LONG cx, LONG cy);
BOOL APIENTRY WinIntersectRect (HAB hab, PRECTL prclDst, __const__ RECTL *prclSrc1,
    __const__ RECTL *prclSrc2);
BOOL APIENTRY WinIsRectEmpty (HAB hab, __const__ RECTL *prcl);
...
BOOL APIENTRY WinPtInRect (HAB hab, __const__ RECTL *prcl, __const__ POINTL *pptl);
BOOL APIENTRY WinSetRect (HAB hab, PRECTL prcl, LONG xLeft, LONG yBottom, LONG xRight,
    LONG yTop);
BOOL APIENTRY WinSetRectEmpty (HAB hab, PRECTL prcl);
BOOL APIENTRY WinSubtractRect (HAB hab, PRECTL prclDst, __const__ RECTL *prclSrc1,
    __const__ RECTL *prclSrc2);
BOOL APIENTRY WinUnionRect (HAB hab, PRECTL prclDst, __const__ RECTL *prclSrc1,
    __const__ RECTL *prclSrc2);
...
LONG APIENTRY WinSetControlColors (HWND hwnd, LONG clrType, ULONG flCtlColor,
    ULONG cCtlColor, PCTLCOLOR pCtlColor);
BOOL APIENTRY WinSetPresParam (HWND hwnd, ULONG id, ULONG cbParam, PVOID pbParam);
BOOL APIENTRY WinSetSysColors (HWND hwndDesktop, ULONG flOptions, ULONG flFormat,
...
BOOL APIENTRY WinSetClassThunkProc (PCSZ pszClassname, PFN pfnThunkProc);
...
BOOL APIENTRY WinStopTimer (HAB hab, HWND hwnd, ULONG idTimer);
...
LONG APIENTRY GpiAnimatePalette (HPAL hpal, ULONG ulFormat, ULONG ulStart,
...
LONG APIENTRY GpiBox (HPS hps, LONG lControl, __const__ POINTL *pptlPoint, LONG lHRound,
    LONG lVRound);
LONG APIENTRY GpiCallSegmentMatrix (HPS hps, LONG lSegment, LONG lCount,
    __const__ MATRIXLF *pmatlfArray, LONG lOptions);
LONG APIENTRY GpiCharString (HPS hps, LONG lCount, PCCH pchString);
LONG APIENTRY GpiCharStringAt (HPS hps, __const__ POINTL *pptlPoint, LONG lCount,
     PCCH pchString);
LONG APIENTRY GpiCharStringPos (HPS hps, __const__ RECTL *prclRect, ULONG flOptions,
    LONG lCount, PCCH pchString, __const__ LONG *alAdx);
LONG APIENTRY  GpiCharStringPosAt (HPS hps, __const__ POINTL *pptlStart,
...
LONG APIENTRY GpiCombineRegion (HPS hps, HRGN hrgnDest, HRGN hrgnSrc1, HRGN hrgnSrc2,
    LONG lMode);
BOOL APIENTRY GpiComment (HPS hps, LONG lLength, __const__ BYTE *pbData);
BOOL APIENTRY GpiConvert (HPS hps, LONG lSrc, LONG lTarg, LONG lCount,
    PPOINTL aptlPoints);
BOOL APIENTRY GpiConvertWithMatrix (HPS hps, LONG lCountp, PPOINTL aptlPoints,
...
LONG APIENTRY GpiCreateLogFont (HPS hps, __const__ STR8 *pName, LONG lLcid,
    __const__ FATTRS *pfatAttrs);
HPAL APIENTRY GpiCreatePalette (HAB hab, ULONG flOptions, ULONG ulFormat,
    ULONG ulCount, __const__ ULONG *aulTable);
HRGN APIENTRY GpiCreateRegion (HPS hps, LONG lCount, __const__ RECTL *arclRectangles);
BOOL APIENTRY GpiDeleteElement (HPS hps);
BOOL APIENTRY GpiDeleteElementRange (HPS hps, LONG lFirstElement, LONG lLastElement);
...
LONG APIENTRY GpiElement (HPS hps, LONG lType, PCSZ pszDesc, LONG lLength,
...
LONG APIENTRY GpiExcludeClipRectangle (HPS hps, __const__ RECTL *prclRectangle);
LONG APIENTRY GpiFillPath (HPS hps, LONG lPath, LONG lOptions);
LONG APIENTRY GpiFrameRegion (HPS hps, HRGN hrgn, __const__ SIZEL *thickness);
LONG APIENTRY GpiFullArc (HPS hps, LONG lControl, FIXED fxMultiplier);
LONG APIENTRY GpiImage (HPS hps, LONG lFormat, __const__ SIZEL *psizlImageSize,
    LONG lLength, __const__ BYTE *pbData);
LONG APIENTRY GpiIntersectClipRectangle (HPS hps, __const__ RECTL *prclRectangle);
BOOL APIENTRY GpiLabel (HPS hps, LONG lLabel);
LONG APIENTRY GpiLine (HPS hps, __const__ POINTL *pptlEndPoint);
...
LONG APIENTRY GpiMarker (HPS hps, __const__ POINTL *pptlPoint);
BOOL APIENTRY GpiModifyPath (HPS hps, LONG lPath, LONG lMode);
BOOL APIENTRY GpiMove (HPS hps, __const__ POINTL *pptlPoint);
LONG APIENTRY GpiOffsetClipRegion (HPS hps, __const__ POINTL *pptlPoint);
BOOL APIENTRY GpiOffsetElementPointer (HPS hps, LONG loffset);
BOOL APIENTRY GpiOffsetRegion (HPS hps, HRGN Hrgn, __const__ POINTL *pptlOffset);
LONG APIENTRY GpiOutlinePath (HPS hps, LONG lPath, LONG lOptions);
LONG APIENTRY GpiPaintRegion (HPS hps, HRGN hrgn);
LONG APIENTRY GpiPartialArc (HPS hps, __const__ POINTL *pptlCenter, FIXED fxMultiplier,
...
LONG APIENTRY GpiPointArc (HPS hps, __const__ POINTL *pptl2);
LONG APIENTRY GpiPolyFillet (HPS hps, LONG lCount, __const__ POINTL *aptlPoints);
LONG APIENTRY GpiPolyFilletSharp (HPS hps, LONG lCount, __const__ POINTL *aptlPoints,
    __const__ FIXED *afxPoints);
LONG APIENTRY GpiPolygons (HPS hps, ULONG ulCount, __const__ POLYGON *paplgn,
    ULONG flOptions, ULONG flModel);
LONG APIENTRY GpiPolyLine (HPS hps, LONG lCount, __const__ POINTL *aptlPoints);
LONG APIENTRY GpiPolyLineDisjoint (HPS hps, LONG lCount, __const__ POINTL *aptlPoints);
LONG APIENTRY GpiPolyMarker (HPS hps, LONG lCount, __const__ POINTL *aptlPoints);
LONG APIENTRY GpiPolySpline (HPS hps, LONG lCount, __const__ POINTL *aptlPoints);
BOOL APIENTRY GpiPop (HPS hps, LONG lCount);
LONG APIENTRY GpiPtInRegion (HPS hps, HRGN hrgn, __const__ POINTL *pptlPoint);
LONG APIENTRY GpiPtVisible (HPS hps, __const__ POINTL *pptlPoint);
BOOL APIENTRY GpiQueryArcParams (HPS hps, PARCPARAMS parcpArcParams);
LONG APIENTRY GpiQueryAttrMode (HPS hps);
LONG APIENTRY GpiQueryAttrs (HPS hps, LONG lPrimType, ULONG flAttrMask,
    PBUNDLE ppbunAttrs);
...
BOOL APIENTRY GpiQueryCharStringPosAt (HPS hps, PPOINTL pptlStart, ULONG flOptions,
...
BOOL APIENTRY GpiQueryDefaultViewMatrix (HPS hps, LONG lCount, PMATRIXLF pmatlfArray);
LONG APIENTRY GpiQueryEditMode (HPS hps);
LONG APIENTRY GpiQueryElement (HPS hps, LONG lOff, LONG lMaxLength, PBYTE pbData);
LONG APIENTRY GpiQueryElementPointer (HPS hps);
LONG APIENTRY GpiQueryElementType (HPS hps, PLONG plType, LONG lLength, PSZ pszData);
ULONG APIENTRY GpiQueryFaceString (HPS PS, PCSZ FamilyName, PFACENAMEDESC attrs,
    LONG length, PSZ CompoundFaceName);
ULONG APIENTRY GpiQueryFontAction (HAB anchor, ULONG options);
LONG APIENTRY GpiQueryFontFileDescriptions (HAB hab, PCSZ pszFilename, PLONG plCount,
...
LONG APIENTRY GpiQueryFullFontFileDescs (HAB hab, PCSZ pszFilename, PLONG plCount,
    PVOID pNames, PLONG plNamesBuffLength);
BOOL APIENTRY GpiQueryGraphicsField (HPS hps, PRECTL prclField);
LONG APIENTRY GpiQueryKerningPairs (HPS hps, LONG lCount, PKERNINGPAIRS akrnprData);
...
LONG APIENTRY GpiQueryLogColorTable (HPS hps, ULONG flOptions, LONG lStart, LONG lCount,
    PLONG alArray);
BOOL APIENTRY GpiQueryLogicalFont (HPS PS, LONG lcid, PSTR8 name, PFATTRS attrs,
    LONG length);
...
BOOL APIENTRY GpiQueryMetaFileBits (HMF hmf, LONG lOffset, LONG lLength, PBYTE pbData);
...
LONG APIENTRY GpiQueryNearestPaletteIndex(HPAL hpal, ULONG ulColor);
...
LONG APIENTRY GpiQueryRealColors (HPS hps, ULONG flOptions, LONG lStart, LONG lCount,
    PLONG alColors);
...
BOOL APIENTRY GpiQuerySegmentTransformMatrix (HPS hps, LONG lSegid, LONG lCount,
    PMATRIXLF pmatlfArray);
BOOL APIENTRY GpiQuerySetIds (HPS hps, LONG lCount, PLONG alTypes, PSTR8 aNames,
    PLONG allcids);
BOOL APIENTRY GpiQueryTextAlignment (HPS hps, PLONG plHoriz, PLONG plVert);
BOOL APIENTRY GpiQueryTextBox (HPS hps, LONG lCount1, PCH pchString, LONG lCount2,
    PPOINTL aptlPoints);
...
BOOL APIENTRY GpiQueryViewingTransformMatrix (HPS hps, LONG lCount,
    PMATRIXLF pmatlfArray);
BOOL APIENTRY GpiQueryWidthTable (HPS hps, LONG lFirstChar, LONG lCount, PLONG alData);
LONG APIENTRY GpiRectInRegion (HPS hps, HRGN hrgn, __const__ RECTL *prclRect);
LONG APIENTRY GpiRectVisible (HPS hps, __const__ RECTL *prclRectangle);
ULONG APIENTRY GpiResizePalette(HPAL hpal, ULONG ulNewSize);
BOOL APIENTRY GpiRotate (HPS hps, PMATRIXLF pmatlfArray, LONG lOptions, FIXED fxAngle,
    __const__ POINTL *pptlCenter);
BOOL APIENTRY GpiSaveMetaFile (HMF hmf, PCSZ pszFilename);
BOOL APIENTRY GpiScale (HPS hps, PMATRIXLF pmfatlfArray, LONG lOptions,
    __const__ FIXED *afxScale, __const__ POINTL *pptlCenter);
HPAL APIENTRY GpiSelectPalette (HPS hps, HPAL hpal);
BOOL APIENTRY GpiSetArcParams (HPS hps, __const__ ARCPARAMS *parcpArcParams);
BOOL APIENTRY GpiSetAttrMode (HPS hps, LONG lMode);
BOOL APIENTRY GpiSetAttrs (HPS hps, LONG lPrimType, ULONG flAttrMask, ULONG flDefMask,
...
BOOL APIENTRY GpiSetCharAngle (HPS hps, __const__ GRADIENTL *pgradlAngle);
BOOL APIENTRY GpiSetCharBox (HPS hps, __const__ SIZEF *psizfxBox);
...
BOOL APIENTRY GpiSetCharShear (HPS hps, __const__ POINTL *pptlAngle);
...
BOOL APIENTRY GpiSetCurrentPosition (HPS hps, __const__ POINTL *pptlPoint);
BOOL APIENTRY GpiSetDefArcParams (HPS hps, __const__ ARCPARAMS *parcpArcParams);
...
BOOL APIENTRY GpiSetDefViewingLimits (HPS hps, __const__ RECTL *prclLimits);
...
BOOL APIENTRY GpiSetGraphicsField (HPS hps, __const__ RECTL *prclField);
...
BOOL APIENTRY GpiSetMarkerBox (HPS hps, __const__ SIZEF *psizfxSize);
...
BOOL APIENTRY GpiSetModelTransformMatrix (HPS hps, LONG lCount,
    __const__ MATRIXLF *pmatlfArray, LONG lOptions);
BOOL APIENTRY GpiSetPageViewport (HPS hps, __const__ RECTL *prclViewport);
...
BOOL APIENTRY GpiSetPatternRefPoint (HPS hps, __const__ POINTL *pptlRefPoint);
...
BOOL APIENTRY GpiSetViewingLimits (HPS hps, __const__ RECTL *prclLimits);
...
BOOL APIENTRY GpiTranslate (HPS hps, PMATRIXLF pmatlfArray, LONG lOptions,
...
HBITMAP APIENTRY GpiLoadBitmap (HPS hps, HMODULE Resource, ULONG idBitmap,
...
HBITMAP APIENTRY GpiCreateBitmap (HPS hps, __const__ BITMAPINFOHEADER2 *pbmpNew,
    ULONG flOptions, __const__ BYTE *pbInitData,
    __const__ BITMAPINFO2 *pbmiInfoTable);
LONG APIENTRY GpiDrawBits (HPS hps, __const__ VOID *pBits,
    __const__ BITMAPINFO2 *pbmiInfoTable, LONG lCount,
    __const__ POINTL *aptlPoints, LONG lRop, ULONG flOptions);
LONG APIENTRY GpiFloodFill (HPS hps, LONG lOptions, LONG lColor);
LONG APIENTRY GpiQueryBitmapBits (HPS hps, LONG lScanStart, LONG lScans, PBYTE pbBuffer,
...
LONG APIENTRY GpiSetPel (HPS hps, __const__ POINTL *pptlPoint);
...
BOOL APIENTRY GpiSetPS (HPS hps, __const__ SIZEL *psizlsize, ULONG flOptions);
...
LONG APIENTRY GpiCorrelateChain (HPS hps, LONG lType, __const__ POINTL *pptlPick,
...
BOOL APIENTRY GpiSetPickAperturePosition (HPS hps, __const__ POINTL *pptlPick);
BOOL APIENTRY GpiSetPickApertureSize (HPS hps, LONG lOptions,
...
BOOL APIENTRY GpiEndInkPath (HPS hps, ULONG flOptions);
LONG APIENTRY GpiStrokeInkPath (HPS hps, LONG lPath, LONG lCount,
...
LONG APIENTRY GpiGetData (HPS hps, LONG lSegid, PLONG plOffset, LONG lFormat,
    LONG lLength, PBYTE pbData);
BOOL APIENTRY GpiOpenSegment (HPS hps, LONG lSegment);
LONG APIENTRY GpiPutData (HPS hps, LONG lFormat, PLONG plCount, __const__ BYTE *pbData);
...
BOOL APIENTRY GpiSetSegmentAttrs (HPS hps, LONG lSegid, LONG lAttribute, LONG lValue);
BOOL APIENTRY GpiSetSegmentPriority (HPS hps, LONG lSegid, LONG lRefSegid, LONG lOrder);
...
BOOL APIENTRY DevQueryDeviceNames (HAB hab, PCSZ pszDriverName, PLONG pldn,
    PSTR32 aDeviceName, PSTR64 aDeviceDesc, PLONG pldt, PSTR16 aDataType);
LONG APIENTRY DevQueryHardcopyCaps (HDC hdc, LONG lStartForm, LONG lForms,
    PHCINFO phciHcInfo);
...
HPROGRAM APIENTRY PrfAddProgram (HINI hini, PPROGDETAILS pDetails, HPROGRAM hprogGroup);
BOOL APIENTRY PrfChangeProgram (HINI hini, HPROGRAM hprog, PPROGDETAILS pDetails);
HPROGRAM APIENTRY PrfCreateGroup (HINI hini, PCSZ pszTitle, UCHAR chVisibility);
BOOL APIENTRY PrfDestroyGroup (HINI hini, HPROGRAM hprogGroup);
PROGCATEGORY APIENTRY PrfQueryProgramCategory (HINI hini, PCSZ pszExe);
ULONG APIENTRY PrfQueryProgramHandle (HINI hini, PCSZ pszExe,
...
ULONG APIENTRY PrfQueryDefinition (HINI hini, HPROGRAM hprog, PPROGDETAILS pDetails,
    ULONG ulBufferLength);
BOOL APIENTRY PrfRemoveProgram (HINI hini, HPROGRAM hprog);

HAPP APIENTRY WinStartApp (HWND hwndNotify, PPROGDETAILS pDetails,
...
HSWITCH APIENTRY WinAddSwitchEntry (__const__ SWCNTRL *pswctl);
ULONG APIENTRY WinRemoveSwitchEntry (HSWITCH hsw);
...
ULONG APIENTRY WinChangeSwitchEntry (HSWITCH hsw, __const__ SWCNTRL *pswctl);
HSWITCH APIENTRY WinCreateSwitchEntry (HAB hab, __const__ SWCNTRL *pswctl);
ULONG APIENTRY WinQuerySessionTitle (HAB hab, ULONG usSession, PSZ pszTitle,
    ULONG usTitlelen);
ULONG APIENTRY WinQuerySwitchEntry (HSWITCH hsw, PSWCNTRL pswctl);
HSWITCH APIENTRY WinQuerySwitchHandle (HWND hwnd, PID pid);
ULONG APIENTRY WinQuerySwitchList (HAB hab, PSWBLOCK pswblk, ULONG usDataLength);
ULONG APIENTRY WinQueryTaskSizePos (HAB hab, ULONG usScreenGroup, PSWP pswp);
ULONG APIENTRY WinQueryTaskTitle (ULONG usSession, PSZ pszTitle, ULONG usTitlelen);
ULONG APIENTRY WinSwitchToProgram (HSWITCH hsw);
...
BOOL APIENTRY PrfQueryProfileData (HINI hini, PCSZ pszApp, PCSZ pszKey, PVOID pBuffer,
    PULONG pulBufferLength);
LONG APIENTRY PrfQueryProfileInt (HINI hini, PCSZ pszApp, PCSZ pszKey, LONG  sDefault);
BOOL APIENTRY PrfQueryProfileSize (HINI hini, PCSZ pszApp, PCSZ pszKey,
    PULONG pulReqLen);
ULONG APIENTRY PrfQueryProfileString (HINI hini, PCSZ pszApp, PCSZ pszKey,
    PCSZ pszDefault, PVOID pBuffer, ULONG ulBufferLength);
BOOL APIENTRY PrfReset (HAB hab, __const__ PRFPROFILE *pPrfProfile);
BOOL APIENTRY PrfWriteProfileData (HINI hini, PCSZ pszApp, PCSZ pszKey,
    CPVOID pData, ULONG ulDataLength);
BOOL APIENTRY PrfWriteProfileString (HINI hini, PCSZ pszApp, PCSZ pszKey,
    PCSZ pszData);
...
BOOL APIENTRY DrgAcceptDroppedFiles (HWND hwnd, PCSZ pszPath, PCSZ pszTypes,
...
HWND APIENTRY DrgDrag (HWND hwndSource, PDRAGINFO pdinfo, PDRAGIMAGE pdimg,
    ULONG cdimg, LONG vkTerminate, PVOID pReserved);
BOOL APIENTRY DrgDragFiles (HWND hwnd, PSZ *apszFiles, PSZ *apszTypes, PSZ *apszTargets,
...
BOOL APIENTRY DrgLazyDrag (HWND hwndSource, PDRAGINFO pDraginfo, PDRAGIMAGE pdimg,
    ULONG cdimg, PVOID pReserved);
BOOL APIENTRY DrgLazyDrop (HWND hwndTarget, ULONG ulOperation, PPOINTL pptlDrop);
BOOL APIENTRY DrgPostTransferMsg (HWND hwnd, ULONG msg, PDRAGTRANSFER pdxfer, ULONG fl,
    ULONG ulReserved, BOOL fRetry);
BOOL APIENTRY DrgPushDraginfo (PDRAGINFO pdinfo, HWND hwndDest);
PDRAGINFO APIENTRY DrgQueryDraginfoPtr (PDRAGINFO pReserved);
PDRAGINFO APIENTRY DrgQueryDraginfoPtrFromHwnd (HWND hwndSource);
PDRAGINFO APIENTRY DrgQueryDraginfoPtrFromDragitem (__const__ DRAGITEM *pDragitem);
BOOL APIENTRY DrgQueryDragitem (PDRAGINFO pdinfo, ULONG cbBuffer, PDRAGITEM pditem,
    ULONG iItem);
ULONG APIENTRY DrgQueryDragitemCount (PDRAGINFO pdinfo);
PDRAGITEM APIENTRY DrgQueryDragitemPtr (PDRAGINFO pdinfo, ULONG ulIndex);
ULONG APIENTRY DrgQueryDragStatus (VOID);
BOOL APIENTRY DrgQueryNativeRMF (PDRAGITEM pditem, ULONG cbBuffer, PCHAR pBuffer);
ULONG APIENTRY DrgQueryNativeRMFLen (PDRAGITEM pditem);
ULONG APIENTRY DrgQueryStrName (HSTR hstr, ULONG cbBuffer, PSZ pBuffer);
ULONG APIENTRY DrgQueryStrNameLen (HSTR hstr);
BOOL APIENTRY DrgQueryTrueType (PDRAGITEM pditem, ULONG cbBuffer, PSZ pBuffer);
ULONG APIENTRY DrgQueryTrueTypeLen (PDRAGITEM pditem);
PDRAGINFO APIENTRY DrgReallocDraginfo (PDRAGINFO pDraginfoOld, ULONG cditem);
BOOL APIENTRY DrgReleasePS (HPS hps);
MRESULT APIENTRY DrgSendTransferMsg (HWND hwnd, ULONG msg, MPARAM mp1, MPARAM mp2);
BOOL APIENTRY DrgSetDragImage (PDRAGINFO pdinfo, PDRAGIMAGE pdimg, ULONG cdimg,
    PVOID pReserved);
BOOL APIENTRY DrgSetDragitem (PDRAGINFO pdinfo, PDRAGITEM pditem, ULONG cbBuffer,
    ULONG iItem);
BOOL APIENTRY DrgSetDragPointer (PDRAGINFO pdinfo, HPOINTER hptr);
BOOL APIENTRY DrgVerifyNativeRMF (PDRAGITEM pditem, PCSZ pszRMF);
...
BOOL APIENTRY DrgVerifyTypeSet (PDRAGITEM pditem, PCSZ pszType, ULONG cbMatch,
    PSZ pszMatch);
...
HOBJECT APIENTRY WinCopyObject (HOBJECT hObjectofObject, HOBJECT hObjectofDest,
    ULONG ulReserved);
HOBJECT APIENTRY WinCreateObject (PCSZ pszClassName, PCSZ pszTitle, PCSZ pszSetupString,
    PCSZ pszLocation, ULONG ulFlags);
HOBJECT APIENTRY WinCreateShadow (HOBJECT hObjectofObject, HOBJECT hObjectofDest,
    ULONG ulReserved);
BOOL APIENTRY WinDeregisterObjectClass (PCSZ pszClassName);
BOOL APIENTRY WinDestroyObject (HOBJECT hObject);
BOOL APIENTRY WinEnumObjectClasses (POBJCLASS pObjClass, PULONG pulSize);
BOOL APIENTRY WinIsSOMDDReady (VOID);
BOOL APIENTRY WinIsWPDServerReady (VOID);
HOBJECT APIENTRY WinMoveObject (HOBJECT hObjectofObject, HOBJECT hObjectofDest,
    ULONG ulReserved);
BOOL APIENTRY WinOpenObject (HOBJECT hObject, ULONG ulView, BOOL fFlag);
BOOL APIENTRY WinQueryActiveDesktopPathname (PSZ pszPathName, ULONG ulSize);
HOBJECT APIENTRY WinQueryObject (PCSZ pszObjectID);
BOOL APIENTRY WinQueryObjectPath (HOBJECT hobject, PSZ pszPathName, ULONG ulSize);
BOOL APIENTRY WinRegisterObjectClass (PCSZ pszClassName, PCSZ pszModName);
BOOL APIENTRY WinReplaceObjectClass (PCSZ pszOldClassName, PCSZ pszNewClassName,
    BOOL fReplace);
ULONG APIENTRY WinRestartSOMDD (BOOL fState);
ULONG APIENTRY WinRestartWPDServer (BOOL fState);
BOOL APIENTRY WinSaveObject (HOBJECT hObject, BOOL fAsync);
BOOL APIENTRY WinSetObjectData (HOBJECT hObject, PCSZ pszSetupString);
...
HPOINTER APIENTRY WinLoadFileIcon (PCSZ pszFileName, BOOL fPrivate);
BOOL APIENTRY WinRestoreWindowPos (PCSZ pszAppName, PCSZ pszKeyName, HWND hwnd);
#if defined (INCL_WINPOINTERS)
BOOL APIENTRY WinSetFileIcon (PCSZ pszFileName, __const__ ICONINFO *pIconInfo);
#endif
BOOL APIENTRY WinShutdownSystem (HAB hab, HMQ hmq);
BOOL APIENTRY WinStoreWindowPos (PCSZ pszAppName, PCSZ pszKeyName, HWND hwnd);
...
SPLERR APIENTRY SplControlDevice (PSZ pszComputerName, PSZ pszPortName,
    ULONG ulControl);
SPLERR APIENTRY SplCopyJob (PCSZ pszSrcComputerName, PCSZ pszSrcQueueName,
    ULONG ulSrcJob, PCSZ pszTrgComputerName, PCSZ pszTrgQueueName,
    PULONG pulTrgJob);
SPLERR APIENTRY SplCreateDevice (PSZ pszComputerName, ULONG ulLevel, PVOID pBuf,
    ULONG cbBuf);
SPLERR APIENTRY SplCreatePort (PCSZ pszComputerName, PCSZ pszPortName,
    PCSZ pszPortDriver, ULONG ulVersion, PVOID pBuf, ULONG cbBuf);
SPLERR APIENTRY SplCreateQueue (PSZ pszComputerName, ULONG ulLevel, PVOID pBuf,
    ULONG cbBuf);
SPLERR APIENTRY SplDeleteDevice (PSZ pszComputerName, PSZ pszPrintDeviceName);
SPLERR APIENTRY SplDeleteJob (PSZ pszComputerName, PSZ pszQueueName, ULONG ulJob);
SPLERR APIENTRY SplDeletePort (PCSZ pszComputerName, PCSZ pszPortName);
SPLERR APIENTRY SplDeleteQueue (PSZ pszComputerName, PSZ pszQueueName);
SPLERR APIENTRY SplEnumDevice (PSZ pszComputerName, ULONG ulLevel, PVOID pBuf,
    ULONG cbBuf, PULONG pcReturned, PULONG pcTotal, PULONG pcbNeeded,
    PVOID pReserved);
SPLERR APIENTRY SplEnumDriver (PSZ pszComputerName, ULONG ulLevel, PVOID pBuf,
    ULONG cbBuf, PULONG pcReturned, PULONG pcTotal, PULONG pcbNeeded,
    PVOID pReserved);
SPLERR APIENTRY SplEnumJob (PSZ pszComputerName, PSZ pszQueueName, ULONG ulLevel,
    PVOID pBuf, ULONG cbBuf, PULONG pcReturned, PULONG pcTotal,
    PULONG pcbNeeded, PVOID pReserved);
SPLERR APIENTRY SplEnumPort (PCSZ pszComputerName, ULONG ulLevel, PVOID pBuf,
    ULONG cbBuf, PULONG pcReturned, PULONG pcTotal, PULONG pcbNeeded,
    PVOID pReserved);
SPLERR APIENTRY SplEnumPrinter (PSZ pszComputerName, ULONG uLevel, ULONG flType,
    PVOID pBuf, ULONG cbbuf, PULONG pcReturned, PULONG pcTotal,
    PULONG pcbNeeded, PVOID pReserved);
SPLERR APIENTRY SplEnumQueue (PSZ pszComputerName, ULONG ulLevel, PVOID pBuf,
    ULONG cbBuf, PULONG pcReturned, PULONG pcTotal, PULONG pcbNeeded,
    PVOID pReserved);
SPLERR APIENTRY SplEnumQueueProcessor (PSZ pszComputerName, ULONG ulLevel, PVOID pBuf,
    ULONG cbBuf, PULONG pcReturned, PULONG pcTotal, PULONG pcbNeeded,
    PVOID pReserved);
SPLERR APIENTRY SplHoldJob (PCSZ pszComputerName, PCSZ pszQueueName, ULONG ulJob);
SPLERR APIENTRY SplHoldQueue (PSZ pszComputerName, PSZ pszQueueName);
SPLERR APIENTRY SplPurgeQueue (PSZ pszComputerName, PSZ pszQueueName);
SPLERR APIENTRY SplQueryDevice (PSZ pszComputerName, PSZ pszPrintDeviceName,
    ULONG ulLevel, PVOID pBuf, ULONG cbBuf, PULONG pcbNeeded);
SPLERR APIENTRY SplQueryDriver (PCSZ pszComputerName, PCSZ pszDriverName,
    PCSZ pszPrinterName, ULONG ulLevel, PVOID pBuf, ULONG cbBuf,
    PULONG pcbNeeded);
SPLERR APIENTRY SplQueryJob (PSZ pszComputerName, PSZ pszQueueName, ULONG ulJob,
    ULONG ulLevel, PVOID pBuf, ULONG cbBuf, PULONG pcbNeeded);
SPLERR APIENTRY SplQueryPort (PCSZ pszComputerName, PCSZ pszPortName, ULONG ulLevel,
    PVOID pBuf, ULONG cbBuf, PULONG pcbNeeded);
SPLERR APIENTRY SplQueryQueue (PSZ pszComputerName, PSZ pszQueueName, ULONG ulLevel,
    PVOID pBuf, ULONG cbBuf, PULONG pcbNeeded);
SPLERR APIENTRY SplReleaseJob (PCSZ pszComputerName, PCSZ pszQueueName, ULONG ulJob);
SPLERR APIENTRY SplReleaseQueue (PSZ pszComputerName, PSZ pszQueueName);
SPLERR APIENTRY SplSetDevice (PSZ pszComputerName, PSZ pszPrintDeviceName,
    ULONG ulLevel, PVOID pBuf, ULONG cbBuf, ULONG ulParmNum);
SPLERR APIENTRY SplSetDriver (PCSZ pszComputerName, PCSZ pszDriverName,
    PCSZ pszPrinterName, ULONG ulLevel, PVOID pBuf, ULONG cbBuf,
    ULONG ulParmNum);
SPLERR APIENTRY SplSetJob (PSZ pszComputerName, PSZ pszQueueName, ULONG ulJob,
    ULONG ulLevel, PVOID pBuf, ULONG cbBuf, ULONG ulParmNum);
SPLERR APIENTRY SplSetPort (PCSZ pszComputerName, PCSZ pszPortName, ULONG ulLevel,
    PVOID pBuf, ULONG cbBuf, ULONG ulParmNum);
SPLERR APIENTRY SplSetQueue (PSZ pszComputerName, PSZ pszQueueName, ULONG ulLevel,
    PVOID pBuf, ULONG cbBuf, ULONG ulParmNum);

ULONG APIENTRY SplMessageBox (PSZ pszLogAddr, ULONG fErrInfo, ULONG fErrData,
...
ULONG APIENTRY SplQmGetJobID (HSPL hspl, ULONG ulLevel, PVOID pBuf, ULONG cbBuf,
    PULONG pcbNeeded);
BOOL APIENTRY SplQmNewPage (HSPL hspl, ULONG ulPageNumber);
HSPL APIENTRY SplQmOpen (PSZ pszToken, LONG lCount, PQMOPENDATA pqmdopData);
BOOL APIENTRY SplQmStartDoc (HSPL hspl, PSZ pszDocName);
...
BOOL APIENTRY WinLoadHelpTable (HWND hwndHelpInstance, ULONG idHelpTable,
    HMODULE Module);
...
BOOL APIENTRY DdfBeginList (HDDF hddf, ULONG ulWidthDT, ULONG fBreakType,
    ULONG fSpacing);
BOOL APIENTRY DdfBitmap (HDDF hddf, HBITMAP hbm, ULONG fAlign);
BOOL APIENTRY DdfEndList (HDDF hddf);
BOOL APIENTRY DdfHyperText (HDDF hddf, PCSZ pszText, PCSZ pszReference,
    ULONG fReferenceType);
BOOL APIENTRY DdfInform (HDDF hddf, PCSZ pszText, ULONG resInformNumber);
HDDF APIENTRY DdfInitialize (HWND hwndHelpInstance, ULONG cbBuffer, ULONG ulIncrement);
BOOL APIENTRY DdfListItem (HDDF hddf, PCSZ pszTerm, PCSZ pszDescription);
BOOL APIENTRY DdfMetafile (HDDF hddf, HMF hmf, __const__ RECTL *prclRect);
BOOL APIENTRY DdfPara (HDDF hddf);
BOOL APIENTRY DdfSetColor (HDDF hddf, COLOR fBackColor, COLOR fForColor);
BOOL APIENTRY DdfSetFont (HDDF hddf, PCSZ pszFaceName, ULONG ulWidth, ULONG ulHeight);
BOOL APIENTRY DdfSetFontStyle (HDDF hddf, ULONG fFontStyle);
BOOL APIENTRY DdfSetFormat (HDDF hddf, ULONG fFormatType);
BOOL APIENTRY DdfSetTextAlign (HDDF hddf, ULONG fAlign);
BOOL APIENTRY DdfText (HDDF hddf, PCSZ pszText);
...
USHORT APIENTRY VioCreateLogFont (PFATTRS pfatattrs, LONG llcid, PSTR8 pName,
    HVPS hvps);
USHORT APIENTRY VioCreatePS (PHVPS phvps, SHORT sDepth, SHORT sWidth, SHORT sFormat,
...
USHORT APIENTRY VioQueryFonts (PLONG plRemfonts, PFONTMETRICS afmMetrics,
    ...
    HVPS hvps);
USHORT APIENTRY VioQuerySetIds (PLONG allcids, PSTR8 pNames, PLONG alTypes, LONG lcount,
    HVPS hvps);
...
MRESULT APIENTRY WinDefAVioWindowProc (HWND hwnd, USHORT msg, ULONG mp1, ULONG mp2);
...
USHORT APIENTRY KbdGetStatus (PKBDINFO pkbdinfo, HKBD hkbd);
USHORT APIENTRY KbdOpen (PHKBD phkbd);
USHORT APIENTRY KbdPeek (PKBDKEYINFO pkbci, HKBD hkbd);
USHORT APIENTRY KbdRegister (PCSZ pszModName, PCSZ pszEntryName, ULONG ulFunMask);
USHORT APIENTRY KbdSetCp (USHORT usReserved, USHORT idCP, HKBD hkbd);
USHORT APIENTRY KbdSetCustXt (PUSHORT pusCodePage, HKBD hkbd);
USHORT APIENTRY KbdSetFgnd (VOID);
USHORT APIENTRY KbdSetHWID (PKBDHWID pkbdhwid, HKBD hkbd);
USHORT APIENTRY KbdSetStatus (PKBDINFO pkbdinfo, HKBD hkbd);
USHORT APIENTRY KbdStringIn (PCH pch, PSTRINGINBUF pchIn, USHORT fWait, HKBD hkbd);
USHORT APIENTRY KbdSynch (USHORT fWait);
...
USHORT APIENTRY VioCheckCharType (PUSHORT pType, USHORT usRow, USHORT usColumn,
    HVIO hvio);
...
USHORT APIENTRY VioGetConfig (USHORT usConfigId, PVIOCONFIGINFO pvioin, HVIO hvio);
USHORT APIENTRY VioGetCp (USHORT usReserved, PUSHORT pusCodePage, HVIO hvio);
...
USHORT APIENTRY VioGlobalReg (PCSZ pszModName, PCSZ pszEntryName, ULONG ulFunMask1,
    ULONG ulFunMask2, USHORT usReturn);
USHORT APIENTRY VioModeUndo (USHORT usOwnerInd, USHORT usKillInd, USHORT usReserved);
USHORT APIENTRY VioModeWait (USHORT usReqType, PUSHORT pNotifyType, USHORT usReserved);
...
USHORT APIENTRY VioReadCharStr (PCH pch, PUSHORT pcb, USHORT usRow, USHORT usColumn,
    HVIO hvio);
USHORT APIENTRY VioRegister (PCSZ pszModName, PCSZ pszEntryName, ULONG ulFunMask1,
    ULONG ulFunMask2);
USHORT APIENTRY VioSavRedrawUndo (USHORT usOwnerInd, USHORT usKillInd,
    USHORT usReserved);
USHORT APIENTRY VioSavRedrawWait (USHORT usRedrawInd, PUSHORT pusNotifyType,
    USHORT usReserved);
USHORT APIENTRY VioScrLock (USHORT fWait, PUCHAR pfNotLocked, HVIO hvio);
USHORT APIENTRY VioScrollDn (USHORT usTopRow, USHORT usLeftCol, USHORT usBotRow,
    USHORT usRightCol, USHORT cbLines, PBYTE pCell, HVIO hvio);
USHORT APIENTRY VioScrollLf (USHORT usTopRow, USHORT usLeftCol, USHORT usBotRow,
    USHORT usRightCol, USHORT cbCol, PBYTE pCell, HVIO hvio);
USHORT APIENTRY VioScrollRt (USHORT usTopRow, USHORT usLeftCol, USHORT usBotRow,
    USHORT usRightCol, USHORT cbCol, PBYTE pCell, HVIO hvio);
USHORT APIENTRY VioScrollUp (USHORT usTopRow, USHORT usLeftCol, USHORT usBotRow,
    USHORT usRightCol, USHORT cbLines, PBYTE pCell, HVIO hvio);
USHORT APIENTRY VioScrUnLock (HVIO hvio);
USHORT APIENTRY VioSetAnsi (USHORT fAnsi, HVIO hvio);
USHORT APIENTRY VioSetCp (USHORT usReserved, USHORT usCodePage, HVIO hvio);
...
USHORT APIENTRY VioSetState (CPVOID pState, HVIO hvio);
USHORT APIENTRY VioShowBuf (USHORT offLVB, USHORT cb, HVIO hvio);
USHORT APIENTRY VioWrtCellStr (PCCH pchCellStr, USHORT cb, USHORT usRow,
    USHORT usColumn, HVIO hvio);
USHORT APIENTRY VioWrtCharStr (PCCH pch, USHORT cb, USHORT usRow, USHORT usColumn,
    HVIO hvio);
USHORT APIENTRY VioWrtCharStrAtt (PCCH pch, USHORT cb, USHORT usRow, USHORT usColumn,
    PBYTE pAttr, HVIO hvio);
USHORT APIENTRY VioWrtNAttr (__const__ BYTE *pAttr, USHORT cb, USHORT usRow,
    USHORT usColumn, HVIO hvio);
USHORT APIENTRY VioWrtNCell (__const__ BYTE *pCell, USHORT cb, USHORT usRow,
    USHORT usColumn, HVIO hvio);
USHORT APIENTRY VioWrtNChar (PCCH pch, USHORT cb, USHORT usRow, USHORT usColumn,
    HVIO hvio);
USHORT APIENTRY VioWrtTTY (PCCH pch, USHORT cb, HVIO hvio);
...
USHORT APIENTRY MouGetThreshold (PTHRESHOLD pthreshold, HMOU hmou);
USHORT APIENTRY MouInitReal (PCSZ pszDriverName);
USHORT APIENTRY MouOpen (PCSZ pszDvrName, PHMOU phmou);
USHORT APIENTRY MouReadEventQue (PMOUEVENTINFO pmouevEvent, PUSHORT pfWait, HMOU hmou);
USHORT APIENTRY MouRegister (PCSZ pszModName, PCSZ pszEntryName, ULONG ulFunMask);
...
USHORT APIENTRY MouSetThreshold (PTHRESHOLD pthreshold, HMOU hmou);
USHORT APIENTRY MouSynch (USHORT fWait);

#endif /* INCL_MOU */


/* --------------------- Register preservation macros ---------------------- */

#if defined(INCL_FSMACROS) || defined(INCL_PRESERVE_REGISTER_MACROS)

#ifndef FS_DISABLED
#define FS_VAR()        volatile unsigned __fs__;
#define FS_SAVE()       __asm__ __volatile__ ("movl %%fs, %%eax; movl %%eax,%0;" : : "m" (__fs__) : "%eax" )
#define FS_SAVE_LOAD()  __asm__ __volatile__ ("movl %%fs, %%eax; movl %%eax,%0; movl $DosTIB, %%eax; movl %%eax, %%fs" : : "m" (__fs__) : "%eax" )
#define FS_VAR_SAVE_LOAD() FS_VAR(); FS_SAVE_LOAD()
#define FS_RESTORE()    __asm__ __volatile__ ("movl %0, %%eax; movl %%eax,%%fs;" : : "m" (__fs__) : "%eax" )
#else
#define FS_VAR()
#define FS_SAVE()       do { } while(0)
#define FS_SAVE_LOAD()  do { } while(0)
#define FS_RESTORE()    do { } while(0)
#endif

#endif /* INCL_FSMACROS || INCL_PRESERVE_REGISTER_MACROS */

#if defined(INCL_FPCWMACROS) || defined(INCL_PRESERVE_REGISTER_MACROS)

#ifndef FPCW_DISABLED
#define FSCW_VAR()        volatile unsigned __fpcw__;
#define FSCW_SAVE()       __asm__ __volatile__ ("fnstcw %0;" : : "m" (__fpcw__) )
#define FSCW_RESTORE()    __asm__ __volatile__ ("fldcw  %0;" : : "m" (__fpcw__) )
#else
#define FSCW_VAR()
#define FSCW_SAVE()       do { } while(0)
#define FSCW_RESTORE()    do { } while(0)
#endif

#endif /* INCL_FPCWMACROS || INCL_PRESERVE_REGISTER_MACROS */

#if defined(INCL_PRESERVE_REGISTER_MACROS) || (defined(INCL_FSMACROS) && defined(INCL_FPCWMACROS))
# define PRESERVE_REGS_SAVE_LOAD_SAFE()       FS_VAR(); FSCW_VAR(); PRESERVE_REGS_SAVE_LOAD_SAFE_AGAIN()
# define PRESERVE_REGS_SAVE_LOAD_SAFE_AGAIN() do { FS_SAVE_LOAD(); FSCW_SAVE(); } while (0)
# define PRESERVE_REGS_RESTORE()              do { FSCW_RESTORE(); FS_RESTORE(); } while (0)
#endif
...
#if defined(INCL_DOSINFOSEG) && !defined(INCL_NO16BIT)
...
#endif /* !defined PT_FULLSCREEN */

/* Take address, these are abs symbols. */
extern void _System DosGlobalInfo(void);
extern void _System DosLocalInfo(void);
#define GETGINFOSEG()       ((PGINFOSEG)(void*)(((unsigned)&DosGlobalInfo & 0xfff8) << 13))
#define GETLINFOSEG()       ((PLINFOSEG)(void*)(((unsigned)&DosLocalInfo & 0xfff8)  << 13))

#if defined (__IBMC__) || defined (__IBMCPP__)
#pragma import (DosGlobalInfo, "DosGlobalInfo", "doscalls", 217)
#pragma import (DosLocalInfo,  "DosLocalInfo",  "doscalls", 216)
#endif
...
#ifdef INCL_DOSUNDOCUEMENTED

/** Check if the current process is being debugged.
 * No parameter. Returns TRUE or FALSE. */
#define DOSSYSCTL_AM_I_DEBUGGED 2

/**
 * System Control Function.
 *
 * @returns Depends on function.
 * @param   ulFunction      Which function to execute.
 *                          Any of the DOSSYSCTL_* #defines.
 */
APIRET APIENTRY DosSysCtl(ULONG ulFunction, PVOID pvParameter);

#endif /* INCL_DOSUNDOCUEMENTED */


#ifdef INCL_EXAPIS

/** Allocate memory at given location. */
#define OBJ_LOCATION    0x01000000
/** The allocated memory object should be duplicated/opened in forked process. */
#define OBJ_FORK        0x02000000
...
/**
 * Extended DosGetSharedMem().
 *
 * @returns See DosGetSharedMem().
 * @param   pv      The address of the shared memory.
 * @param   flFlags Allocation flags. This API supports the same flags as DosGetSharedMem()
 *                  but adds OBJ_FORK. If OBJ_FORK is specified the object will
 *                  be automatically be opened in a forked() process.
 * @remark  The memory must be freed with DosFreeMemEx()!
 */
APIRET APIENTRY DosGetSharedMemEx(PVOID pv, ULONG flFlags);
...
/**
 * Extended DosOpenEventSem() which will make sure the opened semaphore is
 * opened in a forked process with the same handle.
 */
APIRET APIENTRY DosOpenEventSemEx(PSZ pszName, PHEV phev);
/**
...
#ifdef INCL_EXAPIS_MAPPINGS

#define DosAllocMem(a, b, c)       DosAllocMemEx((a),(b),(c) | OBJ_FORK)
#define DosAllocSharedMem(a,b,c,d) DosAllocSharedMemEx((a),(b),(c),(d) | OBJ_FORK)
#define DosFreeMem(a)              DosFreeMemEx((a))

#define DosCreateMutexSem(a,b,c,d) DosCreateMutexSemEx((a),(b),(c),(d))
#define DosCreateEventSem(a,b,c,d) DosCreateEventSemEx((a),(b),(c),(d))
#define DosOpenMutexSem(a,b)       DosOpenMutexSemEx((a),(b))
#define DosOpenEventSem(a,b)       DosOpenEventSemEx((a),(b))
#define DosCloseMutexSem(a)        DosCloseMutexSemEx((a))
#define DosCloseEventSem(a)        DosCloseEventSemEx((a))

#define DosLoadModule(a,b,c,d)     DosLoadModuleEx(a,b,c,d)
#define DosFreeModule(a)           DosFreeModuleEx(a)

#endif /* INCL_EXAPIS_MAPPINGS */
