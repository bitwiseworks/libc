...
foo	proc
	...
	mov	[ebp+0ch],edx;	i2
	mov	[ebp+010h],ecx;	i3
	fstp	dword ptr [ebp+014h];	rf1
	fstp	dword ptr [ebp+018h];	rf2
	fstp	dword ptr [ebp+01ch];	rf3
	fstp	dword ptr [ebp+020h];	rf4
...
CONST32_RO	segment
	align 04h
@CBE6	dd 3fb33333r	; 1.4000000e+00
	align 04h
@CBE7	dd 3fa66666r	; 1.3000000e+00
	align 04h
@CBE8	dd 3f99999ar	; 1.2000000e+00
	align 04h
@CBE9	dd 3f8ccccdr	; 1.1000000e+00
CONST32_RO	ends
CODE32	ends
end
